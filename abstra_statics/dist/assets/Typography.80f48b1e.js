import{V as t,d6 as d,e7 as b,ak as y,B as h,d as f,N as S,f as x,R as c,O as v}from"./outputWidgets.5feddda6.js";(function(){try{var e=typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},o=new Error().stack;o&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[o]="92e09e9d-d5dd-48cc-b8d5-4d322b6fc463",e._sentryDebugIdIdentifier="sentry-dbid-92e09e9d-d5dd-48cc-b8d5-4d322b6fc463")}catch{}})();const T=(e,o,i,r)=>{const{sizeMarginHeadingVerticalEnd:n,fontWeightStrong:a}=r;return{marginBottom:n,color:i,fontWeight:a,fontSize:e,lineHeight:o}},w=e=>{const o=[1,2,3,4,5],i={};return o.forEach(r=>{i[`
      h${r}&,
      div&-h${r},
      div&-h${r} > textarea,
      h${r}
...
//# sourceMappingURL=Typography.80f48b1e.js.map
