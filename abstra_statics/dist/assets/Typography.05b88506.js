import{V as t,d6 as d,e7 as b,ak as y,B as h,d as f,N as S,f as x,R as c,O as v}from"./outputWidgets.23000524.js";(function(){try{var e=typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},o=new Error().stack;o&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[o]="e8c411d2-e8d3-4a9d-b7a2-9081f8e75578",e._sentryDebugIdIdentifier="sentry-dbid-e8c411d2-e8d3-4a9d-b7a2-9081f8e75578")}catch{}})();const T=(e,o,i,r)=>{const{sizeMarginHeadingVerticalEnd:n,fontWeightStrong:a}=r;return{marginBottom:n,color:i,fontWeight:a,fontSize:e,lineHeight:o}},w=e=>{const o=[1,2,3,4,5],i={};return o.forEach(r=>{i[`
      h${r}&,
      div&-h${r},
      div&-h${r} > textarea,
      h${r}
...
//# sourceMappingURL=Typography.05b88506.js.map
