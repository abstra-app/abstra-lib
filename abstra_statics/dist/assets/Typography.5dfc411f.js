import{U as t,d5 as d,e6 as b,aj as f,B as y,d as h,L as S,f as x,Q as c,N as v}from"./outputWidgets.f017b1ba.js";(function(){try{var e=typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},o=new Error().stack;o&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[o]="1f6e0e90-5126-4f60-bf31-2502dd6206fa",e._sentryDebugIdIdentifier="sentry-dbid-1f6e0e90-5126-4f60-bf31-2502dd6206fa")}catch{}})();const T=(e,o,i,r)=>{const{sizeMarginHeadingVerticalEnd:n,fontWeightStrong:a}=r;return{marginBottom:n,color:i,fontWeight:a,fontSize:e,lineHeight:o}},w=e=>{const o=[1,2,3,4,5],i={};return o.forEach(r=>{i[`
      h${r}&,
      div&-h${r},
      div&-h${r} > textarea,
      h${r}
  ...
  `]:{display:"inline-block",maxWidth:"100%"},"&-single-line":{whiteSpace:"nowrap"},"&-ellipsis-single-line":{overflow:"hidden",textOverflow:"ellipsis","a&, span&":{verticalAlign:"bottom"}},"&-ellipsis-multiple-line":{display:"-webkit-box",overflow:"hidden",WebkitLineClamp:3,WebkitBoxOrient:"vertical"}}),E=e=>{const{componentCls:o,sizeMarginHeadingVerticalStart:i}=e;return{[o]:t(t(t(t(t(t(t(t(t({color:e.colorText,wordBreak:"break-word",lineHeight:e.lineHeight,[`&${o}-secondary`]:{color:e.colorTextDescription},[`&${o}-success`]:{color:e.colorSuccess},[`&${o}-warning`]:{color:e.colorWarning},[`&${o}-danger`]:{color:e.colorError,"a&:active, a&:focus":{color:e.colorErrorActive},"a&:hover":{color:e.colorErrorHover}},[`&${o}-disabled`]:{color:e.colorTextDisabled,cursor:"not-allowed",userSelect:"none"},[`
      ...
      h5`]:{[`
        ...
        ${o}-edit,
        ${o}-copy
      `]:t(t({},d(e)),{marginInlineStart:e.marginXXS})}),D(e)),C(e)),B()),{"&-rtl":{direction:"rtl"}})}},_=y("Typography",e=>[E(e)],{sizeMarginHeadingVerticalStart:"1.2em",sizeMarginHeadingVerticalEnd:"0.5em"});var H=globalThis&&globalThis.__rest||function(e,o){var i={};for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&o.indexOf(r)<0&&(i[r]=e[r]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var n=0,r=Object.getOwnPropertySymbols(e);n<r.length;n++)o.indexOf(r[n])<0&&Object.prototype.propertyIsEnumerable.call(e,r[n])&&(i[r[n]]=e[r[n]]);return i};const z=()=>({prefixCls:String,direction:String,component:String}),O=h({name:"ATypography",inheritAttrs:!1,props:z(),setup(e,o){let{slots:i,attrs:r}=o;const{prefixCls:n,direction:a}=S("typography",e),[p,g]=_(n);return()=>{var l;const s=t(t({},e),r),{prefixCls:W,direction:j,component:m="article"}=s,u=H(s,["prefixCls","direction","component"]);return p(x(m,c(c({},u),{},{class:v(n.value,{[`${n.value}-rtl`]:a.value==="rtl"},r.class,g.value)}),{default:()=>[(l=i.default)===null||l===void 0?void 0:l.call(i)]}))}}}),P=O;export{P as T,_ as u};
//# sourceMappingURL=Typography.5dfc411f.js.map
