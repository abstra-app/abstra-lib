import{V as t,d6 as d,e7 as b,ak as y,B as h,d as f,N as S,f as x,R as c,O as v}from"./outputWidgets.6eb42f16.js";(function(){try{var e=typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},o=new Error().stack;o&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[o]="33dbd970-9bae-4d5a-a6d6-d4d67077f306",e._sentryDebugIdIdentifier="sentry-dbid-33dbd970-9bae-4d5a-a6d6-d4d67077f306")}catch{}})();const T=(e,o,i,r)=>{const{sizeMarginHeadingVerticalEnd:n,fontWeightStrong:a}=r;return{marginBottom:n,color:i,fontWeight:a,fontSize:e,lineHeight:o}},w=e=>{const o=[1,2,3,4,5],i={};return o.forEach(r=>{i[`
      h${r}&,
      div&-h${r},
      div&-h${r} > textarea,
      h${r}
...
//# sourceMappingURL=Typography.12f99910.js.map
