import{V as t,d6 as d,e7 as b,ak as y,B as h,d as f,N as S,f as x,R as c,O as v}from"./outputWidgets.34ebc37e.js";(function(){try{var e=typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},o=new Error().stack;o&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[o]="3be2548b-733c-4d0e-98e4-dc8cd4363ac5",e._sentryDebugIdIdentifier="sentry-dbid-3be2548b-733c-4d0e-98e4-dc8cd4363ac5")}catch{}})();const T=(e,o,i,r)=>{const{sizeMarginHeadingVerticalEnd:n,fontWeightStrong:a}=r;return{marginBottom:n,color:i,fontWeight:a,fontSize:e,lineHeight:o}},w=e=>{const o=[1,2,3,4,5],i={};return o.forEach(r=>{i[`
      h${r}&,
      div&-h${r},
      div&-h${r} > textarea,
      h${r}
...
//# sourceMappingURL=Typography.316976a3.js.map
