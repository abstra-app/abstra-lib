...
class Execution:
    ...
    def set_stage_run(self, seed_stage_run_id: Optional[str]):
        self.stage_run = self.stage_run_manager.init_stage_run(
            self.stage, seed_stage_run_id
        )
    ...
    def run(self) -> None:
        ...
        self.handle_start()
        seed_stage_run_id = self.received_stage_run_id()
        self.set_stage_run(seed_stage_run_id)
