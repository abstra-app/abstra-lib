...
Last generated: 2024-01-29 16:14:43.474600
"""
...
class AbstraLibApiLocalLogMessage:
    ...
    execution_id: AbstraLibApiLocalLogMessageExecutionId
    payload: AbstraLibApiLocalLogMessagePayload
    runtime_type: AbstraLibApiLocalLogMessageRuntimeType
    runtime_name: AbstraLibApiLocalLogMessageRuntimeName
    created_at: AbstraLibApiLocalLogMessageCreatedAt
    ...
    @staticmethod
    def from_dict(data: typing.Dict[str, typing.Any]) -> "AbstraLibApiLocalLogMessage":
        return AbstraLibApiLocalLogMessage(
            event=str(data["event"]),
            execution_id=str(data["executionId"]),
            payload=dict(**data["payload"]),
            runtime_type=str(data["runtimeType"]),
            runtime_name=str(data["runtimeName"]),
...
class AbstraLibApiStageRunLogs:
    ...
    @staticmethod
    def from_dict(data: typing.Dict[str, typing.Any]) -> "AbstraLibApiStageRunLogs":
        return AbstraLibApiStageRunLogs(
            stage_run=AbstraLibApiStageRun.from_dict(data["stage_run"]),
            logs=[AbstraLibApiLocalLogMessage.from_dict(item) for item in data["logs"]],
            stage=AbstraLibApiStage.from_dict(data["stage"]),
        )
