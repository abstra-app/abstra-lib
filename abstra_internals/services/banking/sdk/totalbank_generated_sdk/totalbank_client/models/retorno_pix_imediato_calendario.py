...
class RetornoPixImediatoCalendario(BaseModel):
    """
    RetornoPixImediatoCalendario
    """  # noqa: E501

    expiracao: Optional[StrictInt] = Field(
        default=None,
        description="Tempo de vida da cobrança, especificado em segundos a partir da data de criação",
    )
    criacao: Optional[datetime] = Field(
        default=None, description="Criação (formato yyyy-MM-dd HH:mm:ss.SSS)"
    )
    __properties: ClassVar[List[str]] = ["expiracao", "criacao"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetornoPixImediatoCalendario from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetornoPixImediatoCalendario from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"expiracao": obj.get("expiracao"), "criacao": obj.get("criacao")}
        )
        return _obj
