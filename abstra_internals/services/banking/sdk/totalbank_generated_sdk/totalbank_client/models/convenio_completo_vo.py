...
class ConvenioCompletoVO(BaseModel):
    """
    ConvenioCompletoVO
    """  # noqa: E501
    ...
    cnpj_titular: Optional[StrictStr] = Field(
        default=None, description="CNPJ do titular", alias="cnpjTitular"
    )
    codigo_banco: Optional[StrictStr] = Field(
        default=None, description="Código do banco", alias="codigoBanco"
    )
    nome_banco: Optional[StrictStr] = Field(
        default=None, description="Nome do banco", alias="nomeBanco"
    )
    descricao_convenio: Optional[StrictStr] = Field(
        default=None, description="Descrição do convênio", alias="descricaoConvenio"
    )
    tipo_servico: Optional[StrictStr] = Field(
        default=None, description="Tipo de serviço", alias="tipoServico"
    )
    modo_operacao: Optional[StrictStr] = Field(
        default=None, description="Modo de operação.", alias="modoOperacao"
    )
    contas: Optional[List[ContaVO]] = Field(default=None, description="Contas")
    parametros_pagamento: Optional[List[ParametroPagamentoVO]] = Field(
        default=None,
        description="Parâmetros de pagamento, específicos para pagador Caixa (104)",
        alias="parametrosPagamento",
    )
    chave_pix: Optional[StrictStr] = Field(
        default=None,
        description="Chave DICT PIX, específica para tipo de serviço PIX",
        alias="chavePIX",
    )
    tamanho_layout: Optional[StrictInt] = Field(
        default=None, description="Tamanho do layout", alias="tamanhoLayout"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConvenioCompletoVO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in contas (list)
        _items = []
        if self.contas:
            for _item_contas in self.contas:
                if _item_contas:
                    _items.append(_item_contas.to_dict())
            _dict["contas"] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in parametros_pagamento (list)
        _items = []
        if self.parametros_pagamento:
            for _item_parametros_pagamento in self.parametros_pagamento:
                if _item_parametros_pagamento:
                    _items.append(_item_parametros_pagamento.to_dict())
            _dict["parametrosPagamento"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConvenioCompletoVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "cnpjTitular": obj.get("cnpjTitular"),
                "codigoBanco": obj.get("codigoBanco"),
                "nomeBanco": obj.get("nomeBanco"),
                "descricaoConvenio": obj.get("descricaoConvenio"),
                "tipoServico": obj.get("tipoServico"),
                "modoOperacao": obj.get("modoOperacao"),
                "contas": [ContaVO.from_dict(_item) for _item in obj["contas"]]
                if obj.get("contas") is not None
                else None,
                "parametrosPagamento": [
                    ParametroPagamentoVO.from_dict(_item)
                    for _item in obj["parametrosPagamento"]
                ]
                if obj.get("parametrosPagamento") is not None
                else None,
                "chavePIX": obj.get("chavePIX"),
                "tamanhoLayout": obj.get("tamanhoLayout"),
            }
        )
        return _obj
