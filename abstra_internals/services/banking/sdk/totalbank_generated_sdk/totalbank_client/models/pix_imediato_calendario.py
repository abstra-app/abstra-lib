...
class PixImediatoCalendario(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["expiracao"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PixImediatoCalendario from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PixImediatoCalendario from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"expiracao": obj.get("expiracao")})
        return _obj
