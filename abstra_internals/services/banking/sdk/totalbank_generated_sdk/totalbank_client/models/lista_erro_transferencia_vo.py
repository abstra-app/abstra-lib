...
class ListaErroTransferenciaVO(BaseModel):
    """
    Lista de erros.
    """  # noqa: E501
    ...
    transferencias: Optional[List[ErroTransferenciaVO]] = Field(
        default=None,
        description="Retornado quando tipo do erro=7. Erro detalhado no campo msgValidacao de cada transferência.",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListaErroTransferenciaVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListaErroTransferenciaVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "transferencias": [
                    ErroTransferenciaVO.from_dict(_item)
                    for _item in obj["transferencias"]
                ]
