...
class RateioBeneficiarioVO(BaseModel):
    """
    Beneficiários do rateio
    """  # noqa: E501

    nome: Optional[StrictStr] = Field(default=None, description="nome do beneficiário")
    valor: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Valor do rateio"
    )
    floating: Optional[StrictInt] = Field(
        default=None, description="Quantidade de dias para rateio"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RateioBeneficiarioVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RateioBeneficiarioVO from a dict"""
        if obj is None:
            return None
