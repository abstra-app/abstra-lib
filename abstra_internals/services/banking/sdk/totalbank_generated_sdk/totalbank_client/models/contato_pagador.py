...
class ContatoPagador(BaseModel):
    """
    Contatos do pagador
    """  # noqa: E501

    nome: Optional[StrictStr] = Field(default=None, description="Nome do contato")
    email: Optional[StrictStr] = Field(default=None, description="E-mail do contato")
    telefone_principal: Optional[StrictStr] = Field(
        default=None,
        description="Telefone principal do contato",
        alias="telefonePrincipal",
    )
    telefone_secundario: Optional[StrictStr] = Field(
        default=None,
        description="Telefone secundário do contato",
        alias="telefoneSecundario",
    )
    site: Optional[StrictStr] = Field(default=None, description="Site do contato")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContatoPagador from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContatoPagador from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "nome": obj.get("nome"),
                "email": obj.get("email"),
                "telefonePrincipal": obj.get("telefonePrincipal"),
                "telefoneSecundario": obj.get("telefoneSecundario"),
                "site": obj.get("site"),
            }
        )
        return _obj
