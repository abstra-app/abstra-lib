...
class JurosMora(BaseModel):
    """
    Juros mora
    """  # noqa: E501

    tipo: Optional[StrictStr] = Field(default=None, description="Tipo")
    dt_juros: Optional[date] = Field(
        default=None, description="Data de juros (formato aaaa-mm-dd)", alias="dtJuros"
    )
    valor: Optional[
        Union[
    ...
    ] = Field(default=None, description="Valor")
    __properties: ClassVar[List[str]] = ["tipo", "dtJuros", "valor"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JurosMora from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JurosMora from a dict"""
        if obj is None:
            return None
