...
class RequisicaoRegistraTituloVO(BaseModel):
    """
    RequisicaoRegistraTituloVO
    """  # noqa: E501

    beneficiario: Optional[Beneficiario] = None
    conta_beneficiario: Optional[ContaBeneficiarioVO] = Field(
        default=None, alias="contaBeneficiario"
    )
    titulo: Optional[Titulo] = None
    __properties: ClassVar[List[str]] = ["beneficiario", "contaBeneficiario", "titulo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RequisicaoRegistraTituloVO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of conta_beneficiario
        if self.conta_beneficiario:
            _dict["contaBeneficiario"] = self.conta_beneficiario.to_dict()
        # override the default output from pydantic by calling `to_dict()` of titulo
        if self.titulo:
            _dict["titulo"] = self.titulo.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RequisicaoRegistraTituloVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "contaBeneficiario": ContaBeneficiarioVO.from_dict(
                    obj["contaBeneficiario"]
                )
                if obj.get("contaBeneficiario") is not None
                else None,
                "titulo": Titulo.from_dict(obj["titulo"])
                if obj.get("titulo") is not None
                else None,
            }
        )
        return _obj
