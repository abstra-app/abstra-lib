...
class SimpleDDA(BaseModel):
    ...
    cpf_cnpj_sacador_avalista: Optional[StrictStr] = Field(
        default=None,
        description="CPF ou CNPJ do sacador avalista",
        alias="cpfCnpjSacadorAvalista",
    )
    nome_sacador_avalista: Optional[StrictStr] = Field(
        default=None,
        description="Nome do sacador avalista",
        alias="nomeSacadorAvalista",
    )
    documento_banco: Optional[StrictStr] = Field(
        default=None, description="Documento banco", alias="documentoBanco"
    )
    ...
    status_pagamento: Optional[StrictStr] = Field(
        default=None, description="Status do pagamento", alias="statusPagamento"
    )
    valor_documento: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Valor do documento em reais", alias="valorDocumento"
    )
    valor_pagamento: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Valor do pagamento em reais", alias="valorPagamento"
    )
    valor_multa: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Valor da multa em reais", alias="valorMulta"
    )
    valor_desconto: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Valor do desconto em reais", alias="valorDesconto"
    )
    valor_abatimento: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="Valor do abatimento em reais",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SimpleDDA from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SimpleDDA from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "cpfCnpjSacadorAvalista": obj.get("cpfCnpjSacadorAvalista"),
                "nomeSacadorAvalista": obj.get("nomeSacadorAvalista"),
                "documentoBanco": obj.get("documentoBanco"),
                "documentoEmpresa": obj.get("documentoEmpresa"),
                "dataVencimento": obj.get("dataVencimento"),
                "codigoBarras": obj.get("codigoBarras"),
                "status": obj.get("status"),
                "statusPagamento": obj.get("statusPagamento"),
