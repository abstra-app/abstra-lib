...
class ChaveEmail(BaseModel):
    """
    Chave e-mail do PIX
    """  # noqa: E501

    email: Optional[StrictStr] = Field(default=None, description="Chave e-mail do PIX.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChaveEmail from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChaveEmail from a dict"""
        if obj is None:
            return None
