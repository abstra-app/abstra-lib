...
class PixImediatoDevedor(BaseModel):
    """
    PixImediatoDevedor
    """  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["inscricao", "nome", "email"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PixImediatoDevedor from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PixImediatoDevedor from a dict"""
        if obj is None:
            return None
