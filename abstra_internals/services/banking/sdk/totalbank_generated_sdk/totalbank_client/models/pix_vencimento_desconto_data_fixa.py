...
class PixVencimentoDescontoDataFixa(BaseModel):
    """
    ...
    data: Optional[date] = Field(
        default=None,
        description="Data limite para o desconto absoluto da cobrança (formato yyyy-MM-dd)",
    )
    valor_perc: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Valor do desconto absoluto", alias="valorPerc"
    )
    __properties: ClassVar[List[str]] = ["data", "valorPerc"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PixVencimentoDescontoDataFixa from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PixVencimentoDescontoDataFixa from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"data": obj.get("data"), "valorPerc": obj.get("valorPerc")}
        )
        return _obj
