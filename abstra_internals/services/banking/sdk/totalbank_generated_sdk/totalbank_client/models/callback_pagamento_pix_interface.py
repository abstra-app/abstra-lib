...
class CallbackPagamentoPIXInterface(BaseModel):
    """
    ...
    tipo_chave: Optional[StrictStr] = Field(
        default=None, description="Tipo da chave pix.", alias="tipoChave"
    )
    agencia_beneficiario: Optional[StrictStr] = Field(
        default=None, description="Agência do beneficiário", alias="agenciaBeneficiario"
    )
    dv_conta_beneficiario: Optional[StrictStr] = Field(
        default=None,
        description="DV da conta do beneficiário",
        alias="dvContaBeneficiario",
    )
    tipo_conta_beneficiario: Optional[StrictStr] = Field(
        default=None,
        description="Tipo de conta do beneficiário.",
        alias="tipoContaBeneficiario",
    )
    conta_beneficiario: Optional[StrictStr] = Field(
        default=None, description="Conta do beneficiário", alias="contaBeneficiario"
    )
    pix_chave: Optional[StrictStr] = Field(
        default=None, description="Chave pix", alias="pixChave"
    )
    banco_beneficiario: Optional[StrictStr] = Field(
        default=None,
        description="Código do banco do beneficiário",
        alias="bancoBeneficiario",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallbackPagamentoPIXInterface from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallbackPagamentoPIXInterface from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "tipoChave": obj.get("tipoChave"),
                "agenciaBeneficiario": obj.get("agenciaBeneficiario"),
                "dvContaBeneficiario": obj.get("dvContaBeneficiario"),
                "tipoContaBeneficiario": obj.get("tipoContaBeneficiario"),
                "contaBeneficiario": obj.get("contaBeneficiario"),
                "pixChave": obj.get("pixChave"),
                "bancoBeneficiario": obj.get("bancoBeneficiario"),
            }
        )
        return _obj
