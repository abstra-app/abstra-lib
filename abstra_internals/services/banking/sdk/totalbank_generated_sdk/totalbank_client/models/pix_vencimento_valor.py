...
class PixVencimentoValor(BaseModel):
    """
    Valor da cobrança com vencimento
    """  # noqa: E501

    original: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Valor original da cobrança"
    )
    multa: Optional[PixVencimentoTipoValor] = None
    juros: Optional[PixVencimentoTipoValor] = None
    abatimento: Optional[PixVencimentoTipoValor] = None
    desconto: Optional[PixVencimentoDesconto] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PixVencimentoValor from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of juros
        if self.juros:
            _dict["juros"] = self.juros.to_dict()
        # override the default output from pydantic by calling `to_dict()` of abatimento
        if self.abatimento:
            _dict["abatimento"] = self.abatimento.to_dict()
        # override the default output from pydantic by calling `to_dict()` of desconto
        if self.desconto:
            _dict["desconto"] = self.desconto.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PixVencimentoValor from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "multa": PixVencimentoTipoValor.from_dict(obj["multa"])
                if obj.get("multa") is not None
                else None,
                "juros": PixVencimentoTipoValor.from_dict(obj["juros"])
                if obj.get("juros") is not None
                else None,
                "abatimento": PixVencimentoTipoValor.from_dict(obj["abatimento"])
                if obj.get("abatimento") is not None
                else None,
                "desconto": PixVencimentoDesconto.from_dict(obj["desconto"])
                if obj.get("desconto") is not None
                else None,
            }
        )
        return _obj
