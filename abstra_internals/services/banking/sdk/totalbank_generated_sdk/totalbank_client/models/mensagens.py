...
class Mensagens(BaseModel):
    ...
    mensagem1: Optional[StrictStr] = Field(default=None, description="Mensagem 1")
    mensagem2: Optional[StrictStr] = Field(default=None, description="Mensagem 2")
    mensagem3: Optional[StrictStr] = Field(default=None, description="Mensagem 3")
    mensagem4: Optional[StrictStr] = Field(default=None, description="Mensagem 4")
    mensagem5: Optional[StrictStr] = Field(default=None, description="Mensagem 5")
    mensagem6: Optional[StrictStr] = Field(default=None, description="Mensagem 6")
    mensagem7: Optional[StrictStr] = Field(default=None, description="Mensagem 7")
    mensagem8: Optional[StrictStr] = Field(default=None, description="Mensagem 8")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Mensagens from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Mensagens from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "mensagem1": obj.get("mensagem1"),
                "mensagem2": obj.get("mensagem2"),
                "mensagem3": obj.get("mensagem3"),
                "mensagem4": obj.get("mensagem4"),
                "mensagem5": obj.get("mensagem5"),
                "mensagem6": obj.get("mensagem6"),
                "mensagem7": obj.get("mensagem7"),
                "mensagem8": obj.get("mensagem8"),
            }
        )
        return _obj
