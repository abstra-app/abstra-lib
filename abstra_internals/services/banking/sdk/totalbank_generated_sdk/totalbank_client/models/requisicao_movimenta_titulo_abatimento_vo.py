...
class RequisicaoMovimentaTituloAbatimentoVO(BaseModel):
    """
    ...
    valor_abatimento: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="valorAbatimento"
    )
    __properties: ClassVar[List[str]] = ["beneficiario", "titulos", "valorAbatimento"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RequisicaoMovimentaTituloAbatimentoVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RequisicaoMovimentaTituloAbatimentoVO from a dict"""
        if obj is None:
            return None
