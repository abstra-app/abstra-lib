...
class RetornoPaginacao(BaseModel):
    """
    ...
    limite_registros_pagina: Optional[
        Annotated[int, Field(le=100, strict=True, ge=100)]
    ] = Field(
        default=None,
        description="O total máximo que cada página trará na consulta é 100",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetornoPaginacao from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetornoPaginacao from a dict"""
        if obj is None:
            return None
