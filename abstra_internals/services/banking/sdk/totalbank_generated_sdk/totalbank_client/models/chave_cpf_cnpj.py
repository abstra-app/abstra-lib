...
class ChaveCpfCnpj(BaseModel):
    """
    Chave CPF/CNPJ do PIX
    """  # noqa: E501

    cpf_cnpj: Optional[StrictStr] = Field(
        default=None, description="Chave CPF/CNPJ do PIX.", alias="cpfCnpj"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChaveCpfCnpj from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChaveCpfCnpj from a dict"""
        if obj is None:
            return None
