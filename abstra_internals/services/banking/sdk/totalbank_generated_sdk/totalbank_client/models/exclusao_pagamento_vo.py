...
class ExclusaoPagamentoVO(BaseModel):
    """
    ExclusaoPagamentoVO
    """  # noqa: E501

    cpf_cnpj_beneficiario: Optional[StrictStr] = Field(
        default=None,
        description="CPF ou CNPJ do beneficiário",
        alias="cpfCnpjBeneficiario",
    )
    nome_beneficiario: Optional[StrictStr] = Field(
        default=None, description="Nome do beneficiário", alias="nomeBeneficiario"
    )
    cpf_cnpj_pagador: Optional[StrictStr] = Field(
        default=None, description="CPF ou CNPJ do pagador", alias="cpfCnpjPagador"
    )
    nome_pagador: Optional[StrictStr] = Field(
        default=None, description="Nome do pagador", alias="nomePagador"
    )
    conta_pagadora: Optional[StrictStr] = Field(
        default=None, description="Conta debitada", alias="contaPagadora"
    )
    descricao: Optional[StrictStr] = Field(
        default=None, description="Descrição do pagamento"
    )
    doc_banco: Optional[StrictStr] = Field(
        default=None, description="Documento banco", alias="docBanco"
    )
    doc_empresa: Optional[StrictStr] = Field(
        default=None, description="Documento empresa", alias="docEmpresa"
    )
    informacao_complementar: Optional[StrictStr] = Field(
        default=None,
        description="Informação complementar",
        alias="informacaoComplementar",
    )
    data_agendamento: Optional[date] = Field(
        default=None,
        description="Data de agendamento do pagamento",
        alias="dataAgendamento",
    )
    ...
    forma_pagamento: Optional[StrictStr] = Field(
        default=None, description="Forma de pagamento", alias="formaPagamento"
    )
    codigo_forma_pagamento: Optional[StrictStr] = Field(
        default=None,
        description="Código da forma de pagamento",
        alias="codigoFormaPagamento",
    )
    nsa_cliente: Optional[StrictStr] = Field(
        default=None, description="NSA do cliente", alias="nsaCliente"
    )
    nsa_totalbank: Optional[StrictStr] = Field(
        default=None, description="NSA do Totalbank", alias="nsaTotalbank"
    )
    status: Optional[StrictStr] = Field(default=None, description="Status do pagamento")
    status_ultima_remsessa: Optional[StrictStr] = Field(
        default=None,
        description="Status da última remessa",
        alias="statusUltimaRemsessa",
    )
    valor_documento: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Valor do documento", alias="valorDocumento"
    )
    valor_pagamento: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Valor pago", alias="valorPagamento"
    )
    retorno_exclusao_pagamento: Optional[StrictStr] = Field(
        default=None,
        description="Retorno da exclusão.",
        alias="retornoExclusaoPagamento",
    )
    __properties: ClassVar[List[str]] = [
        ...
        "nsaTotalbank",
        "status",
        "statusUltimaRemsessa",
        "valorDocumento",
        "valorPagamento",
        "retornoExclusaoPagamento",
    ]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExclusaoPagamentoVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExclusaoPagamentoVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "cpfCnpjBeneficiario": obj.get("cpfCnpjBeneficiario"),
                "nomeBeneficiario": obj.get("nomeBeneficiario"),
                "cpfCnpjPagador": obj.get("cpfCnpjPagador"),
                "nomePagador": obj.get("nomePagador"),
                "contaPagadora": obj.get("contaPagadora"),
                "descricao": obj.get("descricao"),
                "docBanco": obj.get("docBanco"),
                "docEmpresa": obj.get("docEmpresa"),
                "informacaoComplementar": obj.get("informacaoComplementar"),
                "dataAgendamento": obj.get("dataAgendamento"),
                "dataVencimento": obj.get("dataVencimento"),
                "formaPagamento": obj.get("formaPagamento"),
                "codigoFormaPagamento": obj.get("codigoFormaPagamento"),
                "nsaCliente": obj.get("nsaCliente"),
                "nsaTotalbank": obj.get("nsaTotalbank"),
                "status": obj.get("status"),
                "statusUltimaRemsessa": obj.get("statusUltimaRemsessa"),
                "valorDocumento": obj.get("valorDocumento"),
                "valorPagamento": obj.get("valorPagamento"),
                "retornoExclusaoPagamento": obj.get("retornoExclusaoPagamento"),
            }
        )
        return _obj
