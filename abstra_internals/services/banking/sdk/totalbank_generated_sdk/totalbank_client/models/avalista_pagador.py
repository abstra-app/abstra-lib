...
class AvalistaPagador(BaseModel):
    """
    Avalistas do pagador
    """  # noqa: E501

    pessoa: Optional[Pessoa] = None
    endereco: Optional[Endereco] = None
    telefone: Optional[StrictStr] = Field(
        default=None, description="Telefone do avalista"
    )
    __properties: ClassVar[List[str]] = ["pessoa", "endereco", "telefone"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AvalistaPagador from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AvalistaPagador from a dict"""
        if obj is None:
            return None
