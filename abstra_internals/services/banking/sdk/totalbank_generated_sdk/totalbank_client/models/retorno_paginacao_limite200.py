...
class RetornoPaginacaoLimite200(BaseModel):
    """
    Paginação da consulta
    """  # noqa: E501

    pagina_atual: Optional[StrictInt] = Field(
        default=None,
        description="Número da página atual na consulta.",
        alias="paginaAtual",
    )
    pagina_final: Optional[StrictInt] = Field(
        default=None,
        description="Quantidade total de páginas para essa consulta",
        alias="paginaFinal",
    )
    quantidade_registros_pagina_atual: Optional[StrictInt] = Field(
        default=None,
        description="Quantidades de registros na página atual.",
        alias="quantidadeRegistrosPaginaAtual",
    )
    total_registros: Optional[StrictInt] = Field(
        default=None,
        description="Quantidade total de registros para essa consulta.",
        alias="totalRegistros",
    )
    limite_registros_pagina: Optional[
        Annotated[int, Field(le=200, strict=True, ge=200)]
    ] = Field(
        default=None,
        description="O total máximo que cada página trará na consulta é 200",
        alias="limiteRegistrosPagina",
    )
    __properties: ClassVar[List[str]] = [
        "paginaAtual",
        "paginaFinal",
        "quantidadeRegistrosPaginaAtual",
        "totalRegistros",
        "limiteRegistrosPagina",
    ]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetornoPaginacaoLimite200 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetornoPaginacaoLimite200 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "paginaAtual": obj.get("paginaAtual"),
                "paginaFinal": obj.get("paginaFinal"),
                "quantidadeRegistrosPaginaAtual": obj.get(
                    "quantidadeRegistrosPaginaAtual"
                ),
                "totalRegistros": obj.get("totalRegistros"),
                "limiteRegistrosPagina": obj.get("limiteRegistrosPagina"),
            }
        )
        return _obj
