...
class CallbackConvenioVO(BaseModel):
    """
    Descrição do pagador
    """  # noqa: E501
    ...
    cnpj_titular: Optional[StrictStr] = Field(
        default=None, description="CPF/CNPJ do titular", alias="cnpjTitular"
    )
    nome: Optional[StrictStr] = Field(default=None, description="Descrição")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallbackConvenioVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallbackConvenioVO from a dict"""
        if obj is None:
            return None
