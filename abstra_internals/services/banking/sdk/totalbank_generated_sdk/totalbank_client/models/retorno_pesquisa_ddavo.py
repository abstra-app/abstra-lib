...
class RetornoPesquisaDDAVO(BaseModel):
    """
    RetornoPesquisaDDAVO
    """  # noqa: E501

    paginacao: Optional[RetornoPaginacao] = None
    ddas: Optional[List[SimpleDDA]] = None
    __properties: ClassVar[List[str]] = ["paginacao", "ddas"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetornoPesquisaDDAVO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ddas (list)
        _items = []
        if self.ddas:
            for _item_ddas in self.ddas:
                if _item_ddas:
                    _items.append(_item_ddas.to_dict())
            _dict["ddas"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetornoPesquisaDDAVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "ddas": [SimpleDDA.from_dict(_item) for _item in obj["ddas"]]
                if obj.get("ddas") is not None
                else None,
            }
        )
        return _obj
