...
class RetornoPesquisa(BaseModel):
    """
    Retornos
    """  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["codigoRetorno", "mensagemRetorno", "titulos"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetornoPesquisa from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetornoPesquisa from a dict"""
        if obj is None:
            return None
