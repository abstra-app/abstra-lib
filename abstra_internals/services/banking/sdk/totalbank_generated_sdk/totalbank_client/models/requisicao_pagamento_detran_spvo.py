...
class RequisicaoPagamentoDetranSPVO(BaseModel):
    """
    ...
    convenio_pagador: Optional[ConvenioBradescoVO] = Field(
        default=None, alias="convenioPagador"
    )
    tributo: Optional[StrictStr] = Field(default=None, description="Tributo.")
    codigo_renavam: Optional[StrictInt] = Field(
        default=None, description="Renavam do veículo.", alias="codigoRenavam"
    )
    codigo_placa: Optional[StrictStr] = Field(
        default=None, description="Placa do veículo.", alias="codigoPlaca"
    )
    cpf_cnpj_proprietario: Optional[StrictStr] = Field(
        default=None,
        description="CPF/CNPJ do proprietário.",
        alias="cpfCnpjProprietario",
    )
    nome_proprietario: Optional[StrictStr] = Field(
        default=None, description="Nome do proprietário.", alias="nomeProprietario"
    )
    codigo_municipio: Optional[StrictStr] = Field(
        default=None, description="Código do município.", alias="codigoMunicipio"
    )
    codigo_uf: Optional[StrictStr] = Field(
        default=None, description="Código UF.", alias="codigoUF"
    )
    debitos: Optional[List[PagamentoDetranVO]] = Field(
        default=None, description="Lista de pagamentos, limite de 300 pagamentos"
    )
    resposta_imediata: Optional[StrictBool] = Field(
        default=None,
        description="Enviar automaticamente para API (apenas para convênios que autorizam automaticamente).",
        alias="respostaImediata",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RequisicaoPagamentoDetranSPVO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of convenio_pagador
        if self.convenio_pagador:
            _dict["convenioPagador"] = self.convenio_pagador.to_dict()
        # override the default output from pydantic by calling `to_dict()` of each item in debitos (list)
        _items = []
        if self.debitos:
            for _item_debitos in self.debitos:
                if _item_debitos:
                    _items.append(_item_debitos.to_dict())
            _dict["debitos"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RequisicaoPagamentoDetranSPVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "convenioPagador": ConvenioBradescoVO.from_dict(obj["convenioPagador"])
                if obj.get("convenioPagador") is not None
                else None,
                "tributo": obj.get("tributo"),
                "codigoRenavam": obj.get("codigoRenavam"),
                "codigoPlaca": obj.get("codigoPlaca"),
                "cpfCnpjProprietario": obj.get("cpfCnpjProprietario"),
                "nomeProprietario": obj.get("nomeProprietario"),
                "codigoMunicipio": obj.get("codigoMunicipio"),
                "codigoUF": obj.get("codigoUF"),
                "debitos": [
                    PagamentoDetranVO.from_dict(_item) for _item in obj["debitos"]
                ]
                if obj.get("debitos") is not None
                else None,
                "respostaImediata": obj.get("respostaImediata"),
            }
        )
        return _obj
