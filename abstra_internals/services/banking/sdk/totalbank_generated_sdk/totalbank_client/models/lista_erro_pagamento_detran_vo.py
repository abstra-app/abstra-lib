...
class ListaErroPagamentoDetranVO(BaseModel):
    """
    Lista de erros.
    """  # noqa: E501

    codigo: Optional[StrictStr] = Field(
        default=None, description="Código do tipo de erro. Tipos detalhados no enum."
    )
    tipo_erro: Optional[StrictStr] = Field(
        default=None, description="Tipo de erro", alias="tipoErro"
    )
    detalhe: Optional[StrictStr] = Field(default=None, description="Detalhe")
    pagamentos_debitos_veiculares: Optional[List[ErroPagamentoDetranVO]] = Field(
        default=None,
        description="Retornado quando tipo do erro=7. Erro detalhado no campo msgValidacao de cada pagamento.",
        alias="pagamentosDebitosVeiculares",
    )
    __properties: ClassVar[List[str]] = [
        "codigo",
        "tipoErro",
        "detalhe",
        "pagamentosDebitosVeiculares",
    ]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListaErroPagamentoDetranVO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in pagamentos_debitos_veiculares (list)
        _items = []
        if self.pagamentos_debitos_veiculares:
            for (
                _item_pagamentos_debitos_veiculares
            ) in self.pagamentos_debitos_veiculares:
                if _item_pagamentos_debitos_veiculares:
                    _items.append(_item_pagamentos_debitos_veiculares.to_dict())
            _dict["pagamentosDebitosVeiculares"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListaErroPagamentoDetranVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "tipoErro": obj.get("tipoErro"),
                "detalhe": obj.get("detalhe"),
                "pagamentosDebitosVeiculares": [
                    ErroPagamentoDetranVO.from_dict(_item)
                    for _item in obj["pagamentosDebitosVeiculares"]
                ]
                if obj.get("pagamentosDebitosVeiculares") is not None
                else None,
            }
        )
        return _obj
