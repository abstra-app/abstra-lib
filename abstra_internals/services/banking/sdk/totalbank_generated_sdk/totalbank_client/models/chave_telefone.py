...
class ChaveTelefone(BaseModel):
    """
    Chave telefone do PIX
    """  # noqa: E501

    telefone: Optional[StrictStr] = Field(
        default=None, description="Chave telefone do PIX."
    )
    __properties: ClassVar[List[str]] = ["telefone"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChaveTelefone from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChaveTelefone from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"telefone": obj.get("telefone")})
        return _obj
