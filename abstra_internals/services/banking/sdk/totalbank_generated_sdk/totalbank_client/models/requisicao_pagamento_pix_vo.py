...
class RequisicaoPagamentoPixVO(BaseModel):
    """
    ...
    pix: Optional[List[PagamentoPixVO]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RequisicaoPagamentoPixVO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in pix (list)
        _items = []
        if self.pix:
            for _item_pix in self.pix:
                if _item_pix:
                    _items.append(_item_pix.to_dict())
            _dict["pix"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RequisicaoPagamentoPixVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "pix": [PagamentoPixVO.from_dict(_item) for _item in obj["pix"]]
                if obj.get("pix") is not None
                else None,
            }
        )
        return _obj
