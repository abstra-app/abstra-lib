...
class CallbackPagamentoOcorrenciaVO(BaseModel):
    """
    Caso ocorra alguma ocorrência com o pagamento na Instituição bancária, a informação da ocorrrência e sua descrição estará disponível neste array
    """  # noqa: E501

    codigo: Optional[StrictStr] = Field(
        default=None, description="Código da ocorrência"
    )
    descricao: Optional[StrictStr] = Field(
        default=None, description="Descrição traduzida da ocorrência"
    )
    __properties: ClassVar[List[str]] = ["codigo", "descricao"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallbackPagamentoOcorrenciaVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallbackPagamentoOcorrenciaVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"codigo": obj.get("codigo"), "descricao": obj.get("descricao")}
        )
        return _obj
