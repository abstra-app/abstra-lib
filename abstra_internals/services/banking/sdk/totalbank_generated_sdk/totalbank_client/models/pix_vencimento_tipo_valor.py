...
class PixVencimentoTipoValor(BaseModel):
    """
    Abatimento
    """  # noqa: E501

    modalidade: Optional[Annotated[str, Field(strict=True)]] = Field(
        default=None, description="Modalidade"
    )
    valor_perc: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Valor", alias="valorPerc"
    )
    __properties: ClassVar[List[str]] = ["modalidade", "valorPerc"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PixVencimentoTipoValor from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PixVencimentoTipoValor from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"modalidade": obj.get("modalidade"), "valorPerc": obj.get("valorPerc")}
        )
        return _obj
