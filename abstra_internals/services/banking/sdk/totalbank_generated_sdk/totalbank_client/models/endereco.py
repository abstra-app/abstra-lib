...
class Endereco(BaseModel):
    ...
    logradouro: Optional[StrictStr] = Field(
        default=None, description="Logradouro do endereço"
    )
    ...
    uf: Optional[Annotated[str, Field(strict=True)]] = Field(
        default=None, description="UF do endereço"
    )
    cep: Optional[Annotated[str, Field(strict=True)]] = Field(
        default=None, description="CEP do endereço"
    )
    __properties: ClassVar[List[str]] = ["logradouro", "bairro", "cidade", "uf", "cep"]

    @field_validator("uf")
    def uf_validate_regular_expression(cls, value):
    ...
    @field_validator("cep")
    def cep_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Endereco from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Endereco from a dict"""
        if obj is None:
            return None
