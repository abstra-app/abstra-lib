...
class PixVencimentoDescontoValorPerc(BaseModel):
    """
    Valor do desconto
    """  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["valorPerc"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PixVencimentoDescontoValorPerc from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PixVencimentoDescontoValorPerc from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"valorPerc": obj.get("valorPerc")})
        return _obj
