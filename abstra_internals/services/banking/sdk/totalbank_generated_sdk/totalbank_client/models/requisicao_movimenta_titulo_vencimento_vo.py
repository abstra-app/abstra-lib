...
class RequisicaoMovimentaTituloVencimentoVO(BaseModel):
    """
    ...
    nova_data_vencimento: Optional[date] = Field(
        default=None,
        description="Nova data de vencimento do título (formato aaaa-mm-dd)",
        alias="novaDataVencimento",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RequisicaoMovimentaTituloVencimentoVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RequisicaoMovimentaTituloVencimentoVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "novaDataVencimento": obj.get("novaDataVencimento"),
            }
        )
        return _obj
