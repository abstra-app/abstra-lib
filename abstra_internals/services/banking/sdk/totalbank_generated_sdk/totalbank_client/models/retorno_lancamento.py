...
class RetornoLancamento(BaseModel):
    """
    RetornoLancamento
    """  # noqa: E501

    lancamentos: Optional[List[LancamentoVO]] = Field(
        default=None, description="Lançamentos"
    )
    paginacao: Optional[RetornoPaginacaoLimite200] = None
    __properties: ClassVar[List[str]] = ["lancamentos", "paginacao"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetornoLancamento from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in lancamentos (list)
        _items = []
        if self.lancamentos:
            for _item_lancamentos in self.lancamentos:
                if _item_lancamentos:
                    _items.append(_item_lancamentos.to_dict())
            _dict["lancamentos"] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetornoLancamento from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "lancamentos": [
                    LancamentoVO.from_dict(_item) for _item in obj["lancamentos"]
                ]
                if obj.get("lancamentos") is not None
                else None,
                "paginacao": RetornoPaginacaoLimite200.from_dict(obj["paginacao"])
