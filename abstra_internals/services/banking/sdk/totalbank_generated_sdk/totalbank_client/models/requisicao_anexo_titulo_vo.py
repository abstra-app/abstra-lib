...
class RequisicaoAnexoTituloVO(BaseModel):
    """
    RequisicaoAnexoTituloVO
    """  # noqa: E501

    beneficiario: Optional[Beneficiario] = None
    filtro: Optional[FiltroTitulo] = None
    anexo: Optional[WSAnexo] = None
    __properties: ClassVar[List[str]] = ["beneficiario", "filtro", "anexo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RequisicaoAnexoTituloVO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of filtro
        if self.filtro:
            _dict["filtro"] = self.filtro.to_dict()
        # override the default output from pydantic by calling `to_dict()` of anexo
        if self.anexo:
            _dict["anexo"] = self.anexo.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RequisicaoAnexoTituloVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "filtro": FiltroTitulo.from_dict(obj["filtro"])
                if obj.get("filtro") is not None
                else None,
                "anexo": WSAnexo.from_dict(obj["anexo"])
                if obj.get("anexo") is not None
                else None,
            }
        )
        return _obj
