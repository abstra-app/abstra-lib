...
class FuncionarioFavorecidoExcluirVO(BaseModel):
    """
    Funcionário/Favorecido Excluir
    """  # noqa: E501

    cpf_cnpj: Optional[StrictStr] = Field(
        default=None, description="CPF ou CNPJ", alias="cpfCnpj"
    )
    __properties: ClassVar[List[str]] = ["cpfCnpj"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FuncionarioFavorecidoExcluirVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FuncionarioFavorecidoExcluirVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"cpfCnpj": obj.get("cpfCnpj")})
        return _obj
