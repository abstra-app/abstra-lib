...
class RetornoPixImediatoVO(BaseModel):
    """
    Cobrança imediata
    """  # noqa: E501
    ...
    devedor: Optional[PixImediatoDevedor] = None
    valor: Optional[PixImediatoValor] = None
    calendario: Optional[RetornoPixImediatoCalendario] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetornoPixImediatoVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetornoPixImediatoVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "devedor": PixImediatoDevedor.from_dict(obj["devedor"])
                if obj.get("devedor") is not None
                else None,
                "valor": PixImediatoValor.from_dict(obj["valor"])
                if obj.get("valor") is not None
                else None,
                "calendario": RetornoPixImediatoCalendario.from_dict(obj["calendario"])
