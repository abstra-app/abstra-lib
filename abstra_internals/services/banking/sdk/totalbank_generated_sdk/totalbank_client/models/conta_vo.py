...
class ContaVO(BaseModel):
    """
    Conta
    """  # noqa: E501

    agencia: Optional[StrictStr] = Field(default=None, description="Agência")
    dv_agencia: Optional[StrictStr] = Field(
        default=None, description="Dígito verificador da agência", alias="dvAgencia"
    )
    conta_corrente: Optional[StrictStr] = Field(
        default=None, description="Conta corrente", alias="contaCorrente"
    )
    dv_conta_corrente: Optional[StrictStr] = Field(
        default=None,
        description="Dígito verificador da conta corrente",
        alias="dvContaCorrente",
    )
    cnpj_titular: Optional[StrictStr] = Field(
        default=None, description="Titular da conta", alias="cnpjTitular"
    )
    codigo_banco: Optional[StrictStr] = Field(
        default=None, description="Código do banco", alias="codigoBanco"
    )
    titular: Optional[TitularVO] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContaVO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of titular
        if self.titular:
            _dict["titular"] = self.titular.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContaVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "agencia": obj.get("agencia"),
                "dvAgencia": obj.get("dvAgencia"),
                "contaCorrente": obj.get("contaCorrente"),
                "dvContaCorrente": obj.get("dvContaCorrente"),
                "cnpjTitular": obj.get("cnpjTitular"),
                "codigoBanco": obj.get("codigoBanco"),
                "titular": TitularVO.from_dict(obj["titular"])
                if obj.get("titular") is not None
                else None,
            }
        )
        return _obj
