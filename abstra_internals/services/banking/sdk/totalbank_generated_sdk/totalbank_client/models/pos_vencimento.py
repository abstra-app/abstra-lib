...
class PosVencimento(BaseModel):
    """
    Pós vencimento
    """  # noqa: E501

    opcao: Optional[StrictStr] = Field(
        default=None, description="Opção - se protesta ou devolve"
    )
    numero_dias: Optional[StrictInt] = Field(
        default=None, description="Número de dias", alias="numeroDias"
    )
    __properties: ClassVar[List[str]] = ["opcao", "numeroDias"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PosVencimento from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PosVencimento from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"opcao": obj.get("opcao"), "numeroDias": obj.get("numeroDias")}
        )
        return _obj
