...
class PixImediatoValor(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PixImediatoValor from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PixImediatoValor from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"original": obj.get("original")})
        return _obj
