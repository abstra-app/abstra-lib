...
class RetornoTransferenciaVO(BaseModel):
    """
    ...
    tipo_servico: Optional[StrictStr] = Field(
        default=None, description="Descrição do tipo de serviço", alias="tipoServico"
    )
    data_pagamento: Optional[StrictStr] = Field(
        default=None,
        description="Data do pagamento (formato aaaa-mm-dd)",
        alias="dataPagamento",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetornoTransferenciaVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetornoTransferenciaVO from a dict"""
        if obj is None:
            return None
