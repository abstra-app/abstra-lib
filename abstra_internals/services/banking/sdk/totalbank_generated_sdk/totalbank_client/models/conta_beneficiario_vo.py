...
class ContaBeneficiarioVO(BaseModel):
    """
    ...
    banco: Optional[StrictStr] = Field(default=None, description="Código do banco")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContaBeneficiarioVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContaBeneficiarioVO from a dict"""
        if obj is None:
            return None
