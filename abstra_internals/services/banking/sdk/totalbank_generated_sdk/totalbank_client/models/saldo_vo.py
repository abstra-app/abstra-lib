...
class SaldoVO(BaseModel):
    """
    Saldo
    """  # noqa: E501

    conta: Optional[ContaVO] = None
    data_saldo: Optional[date] = Field(
        default=None, description="Data", alias="dataSaldo"
    )
    saldo_inicial: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Saldo inicial", alias="saldoInicial"
    )
    saldo_final: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Saldo final", alias="saldoFinal"
    )
    soma_credito: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Soma de créditos", alias="somaCredito"
    )
    soma_debito: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Soma de débitos", alias="somaDebito"
    )
    saldo_bloqueado: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Saldo bloqueado", alias="saldoBloqueado"
    )
    saldo_disponivel: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Saldo disponível", alias="saldoDisponivel"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SaldoVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SaldoVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "dataSaldo": obj.get("dataSaldo"),
                "saldoInicial": obj.get("saldoInicial"),
                "saldoFinal": obj.get("saldoFinal"),
                "somaCredito": obj.get("somaCredito"),
                "somaDebito": obj.get("somaDebito"),
                "saldoBloqueado": obj.get("saldoBloqueado"),
                "saldoDisponivel": obj.get("saldoDisponivel"),
            }
        )
        return _obj
