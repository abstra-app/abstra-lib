...
class DadosBancariosVO(BaseModel):
    """
    Dados Bancários
    """  # noqa: E501
    ...
    tipo_conta: Optional[StrictStr] = Field(
        default=None, description="Tipo de conta", alias="tipoConta"
    )
    agencia: Optional[StrictStr] = Field(default=None, description="Agência")
    conta: Optional[StrictStr] = Field(default=None, description="Conta corrente")
    grupos: Optional[List[StrictStr]] = Field(
        default=None, description="Grupos / Centro de custo"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DadosBancariosVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DadosBancariosVO from a dict"""
        if obj is None:
            return None
