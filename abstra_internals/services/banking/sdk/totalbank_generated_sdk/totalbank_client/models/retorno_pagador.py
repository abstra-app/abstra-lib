...
class RetornoPagador(BaseModel):
    """
    RetornoPagador
    """  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["codigoRetorno", "mensagemRetorno"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetornoPagador from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetornoPagador from a dict"""
        if obj is None:
            return None
