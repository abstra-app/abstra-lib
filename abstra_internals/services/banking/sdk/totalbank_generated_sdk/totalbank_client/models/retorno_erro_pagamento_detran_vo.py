...
class RetornoErroPagamentoDetranVO(BaseModel):
    """
    RetornoErroPagamentoDetranVO
    """  # noqa: E501

    erros: Optional[List[ListaErroPagamentoDetranVO]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetornoErroPagamentoDetranVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetornoErroPagamentoDetranVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "erros": [
                    ListaErroPagamentoDetranVO.from_dict(_item)
                    for _item in obj["erros"]
                ]
