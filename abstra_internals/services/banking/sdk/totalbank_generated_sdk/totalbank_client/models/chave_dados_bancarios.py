...
class ChaveDadosBancarios(BaseModel):
    """
    Dados bancários do PIX
    """  # noqa: E501

    conta: Optional[StrictStr] = Field(default=None, description="Conta")
    agencia: Optional[StrictStr] = Field(default=None, description="Código da agência")
    dv_conta: Optional[StrictStr] = Field(
        default=None, description="Dígito verificador da conta", alias="dvConta"
    )
    banco: Optional[StrictStr] = Field(default=None, description="Banco")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChaveDadosBancarios from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChaveDadosBancarios from a dict"""
        if obj is None:
            return None
