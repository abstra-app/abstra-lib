...
class Pagador(BaseModel):
    ...
    senha: Optional[StrictStr] = Field(
        default=None, description="Senha de acesso ao portal segunda via"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Pagador from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Pagador from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "endereco": Endereco.from_dict(obj["endereco"])
