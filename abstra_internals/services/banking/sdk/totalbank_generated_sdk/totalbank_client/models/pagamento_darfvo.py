...
class PagamentoDARFVO(BaseModel):
    """
    ...
    codigo_receita: Optional[StrictInt] = Field(
        default=None,
        description="Código da Receita do Tributo DARF",
        alias="codigoReceita",
    )
    codigo_tipo_contribuinte: Optional[StrictStr] = Field(
        default=None,
        description="Código do tipo de contribuinte na DARF",
        alias="codigoTipoContribuinte",
    )
    periodo_apuracao: Optional[StrictStr] = Field(
        default=None,
        description="Periodo de apuração. Formato: (formato aaaa-mm-dd)",
        alias="periodoApuracao",
    )
    numero_referencia: Optional[StrictStr] = Field(
        default=None, description="Numero de referência", alias="numeroReferencia"
    )
    valor_principal: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="Valor principal, em reais (formato 0.00)",
        alias="valorPrincipal",
    )
    valor_multa: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="Valor da multa, em reais (formato 0.00)",
        alias="valorMulta",
    )
    valor_juros_encargos: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="Valor dos juros e encargos, em reais (formato 0.00)",
        alias="valorJurosEncargos",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PagamentoDARFVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PagamentoDARFVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "periodoApuracao": obj.get("periodoApuracao"),
                "numeroReferencia": obj.get("numeroReferencia"),
                "valorPrincipal": obj.get("valorPrincipal"),
                "valorMulta": obj.get("valorMulta"),
                "valorJurosEncargos": obj.get("valorJurosEncargos"),
            }
        )
        return _obj
