...
class RetornoPesquisaComprovantesVO(BaseModel):
    """
    RetornoPesquisaComprovantesVO
    """  # noqa: E501

    paginacao: Optional[RetornoPaginacao] = None
    anexos: Optional[List[WSAnexo]] = Field(
        default=None, description="Lista de comprovantes"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetornoPesquisaComprovantesVO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in anexos (list)
        _items = []
        if self.anexos:
            for _item_anexos in self.anexos:
                if _item_anexos:
                    _items.append(_item_anexos.to_dict())
            _dict["anexos"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetornoPesquisaComprovantesVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "anexos": [WSAnexo.from_dict(_item) for _item in obj["anexos"]]
                if obj.get("anexos") is not None
                else None,
