...
class RequisicaoImprimeTituloVO(BaseModel):
    """
    RequisicaoImprimeTituloVO
    """  # noqa: E501

    beneficiario: Optional[Beneficiario] = None
    titulos: Optional[List[FiltroTitulo]] = Field(default=None, description="Títulos")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RequisicaoImprimeTituloVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RequisicaoImprimeTituloVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "titulos": [FiltroTitulo.from_dict(_item) for _item in obj["titulos"]]
