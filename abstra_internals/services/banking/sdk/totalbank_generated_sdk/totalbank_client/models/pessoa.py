...
class Pessoa(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["inscricao", "nome"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Pessoa from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Pessoa from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"inscricao": obj.get("inscricao"), "nome": obj.get("nome")}
        )
        return _obj
