...
class TitularVO(BaseModel):
    ...
    razao_social: Optional[StrictStr] = Field(
        default=None, description="Razão Social", alias="razaoSocial"
    )
    nome_fantasia: Optional[StrictStr] = Field(
        default=None, description="Nome fantasia", alias="nomeFantasia"
    )
    logradouro: Optional[StrictStr] = Field(default=None, description="Logradouro")
    numero: Optional[StrictStr] = Field(default=None, description="Número")
    complemento: Optional[StrictStr] = Field(default=None, description="Complemento")
    bairro: Optional[StrictStr] = Field(default=None, description="Bairro")
    uf: Optional[StrictStr] = Field(default=None, description="Estado")
    cidade: Optional[StrictStr] = Field(default=None, description="Cidade")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TitularVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TitularVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "razaoSocial": obj.get("razaoSocial"),
                "nomeFantasia": obj.get("nomeFantasia"),
