...
class ErroPagamentoCodigoBarrasVO(BaseModel):
    """
    Retornado quando tipo do erro=7. Erro detalhado no campo erro de cada pagamento.
    """  # noqa: E501

    data_pagamento: Optional[StrictStr] = Field(
        default=None,
        description="Data de pagamento (formato aaaa-mm-dd)",
        alias="dataPagamento",
    )
    documento_empresa: Optional[StrictStr] = Field(
        default=None, description="Documento empresa", alias="documentoEmpresa"
    )
    informacoes_complementares: Optional[StrictStr] = Field(
        default=None,
        description="Informações complementares",
        alias="informacoesComplementares",
    )
    valor: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Valor do pagamento em reais (formato 0.00)"
    )
    msg_validacao: Optional[StrictStr] = Field(
        default=None,
        description="Mensagem da pré-validação individual realizada no momento da inclusão no portal",
        alias="msgValidacao",
    )
    cod_barras: Optional[StrictStr] = Field(
        default=None, description="Código de barras do pagamento", alias="codBarras"
    )
    ...
    nome_pagador: Optional[StrictStr] = Field(
        default=None,
        description="Nome do pagador, informar somente se for diferente do titular da conta débito",
        alias="nomePagador",
    )
    cpf_cnpj_pagador: Optional[StrictStr] = Field(
        default=None,
        description="CPF ou CNPJ do pagador, informar somente se for diferente do titular da conta débito",
        alias="cpfCnpjPagador",
    )
    nome_avalista: Optional[StrictStr] = Field(
        default=None, description="Nome do avalista", alias="nomeAvalista"
    )
    cpf_cnpj_avalista: Optional[StrictStr] = Field(
        default=None, description="CPF ou CNPJ do avalista", alias="cpfCnpjAvalista"
    )
    valor_documento: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="Valor do documento em reais (formato 0.00)",
        alias="valorDocumento",
    )
    valor_juros_multa: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="Valor do juros/multa em reais (formato 0.00)",
        alias="valorJurosMulta",
    )
    valor_desconto_abatimento: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="Valor do desconto ou abatimento em reais (formato 0.00)",
        alias="valorDescontoAbatimento",
    )
    data_vencimento: Optional[StrictStr] = Field(
        default=None,
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ErroPagamentoCodigoBarrasVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ErroPagamentoCodigoBarrasVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "dataPagamento": obj.get("dataPagamento"),
                "documentoEmpresa": obj.get("documentoEmpresa"),
                "informacoesComplementares": obj.get("informacoesComplementares"),
                "valor": obj.get("valor"),
                "msgValidacao": obj.get("msgValidacao"),
                "codBarras": obj.get("codBarras"),
                ...
                "nomeAvalista": obj.get("nomeAvalista"),
                "cpfCnpjAvalista": obj.get("cpfCnpjAvalista"),
                "valorDocumento": obj.get("valorDocumento"),
                "valorJurosMulta": obj.get("valorJurosMulta"),
                "valorDescontoAbatimento": obj.get("valorDescontoAbatimento"),
