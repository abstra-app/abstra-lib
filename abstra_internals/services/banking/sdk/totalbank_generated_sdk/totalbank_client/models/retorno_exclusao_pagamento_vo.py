...
class RetornoExclusaoPagamentoVO(BaseModel):
    """
    RetornoExclusaoPagamentoVO
    """  # noqa: E501

    retornos: Optional[List[ExclusaoPagamentoVO]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetornoExclusaoPagamentoVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetornoExclusaoPagamentoVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "retornos": [
                    ExclusaoPagamentoVO.from_dict(_item) for _item in obj["retornos"]
                ]
