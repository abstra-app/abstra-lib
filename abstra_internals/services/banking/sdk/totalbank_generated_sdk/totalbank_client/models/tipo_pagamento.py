...
class TipoPagamento(BaseModel):
    ...
    tipo: Optional[StrictStr] = Field(default=None, description="Tipo")
    qtd_permitida: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(
        default=None, description="Quantidade permitida", alias="qtdPermitida"
    )
    valor_minimo: Optional[
        Union[
            Annotated[float, Field(strict=True, ge=0)],
            Annotated[int, Field(strict=True, ge=0)],
        ]
    ] = Field(default=None, description="Valor mínimo", alias="valorMinimo")
    valor_maximo: Optional[
        Union[
            Annotated[float, Field(strict=True, ge=0)],
            Annotated[int, Field(strict=True, ge=0)],
        ]
    ] = Field(default=None, description="Valor máximo", alias="valorMaximo")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TipoPagamento from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TipoPagamento from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "tipo": obj.get("tipo"),
                "qtdPermitida": obj.get("qtdPermitida"),
                "valorMinimo": obj.get("valorMinimo"),
                "valorMaximo": obj.get("valorMaximo"),
            }
        )
        return _obj
