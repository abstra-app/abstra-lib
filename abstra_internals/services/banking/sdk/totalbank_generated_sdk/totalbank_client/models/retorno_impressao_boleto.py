...
class RetornoImpressaoBoleto(BaseModel):
    """
    ...
    anexos: Optional[List[ConteudoBoleto]] = None
    __properties: ClassVar[List[str]] = ["codigoRetorno", "mensagemRetorno", "anexos"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetornoImpressaoBoleto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetornoImpressaoBoleto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "anexos": [ConteudoBoleto.from_dict(_item) for _item in obj["anexos"]]
