...
class FiltroTitulo(BaseModel):
    """
    Títulos
    """  # noqa: E501

    cpf_cnpj_pagador: Optional[StrictStr] = Field(
        default=None, description="CPF/CNPJ do pagador", alias="cpfCnpjPagador"
    )
    nosso_numero: Optional[StrictStr] = Field(
        default=None, description="Nosso número do título", alias="nossoNumero"
    )
    uso_empresa: Optional[StrictStr] = Field(
        default=None, description="Uso empresa do título", alias="usoEmpresa"
    )
    seu_numero: Optional[StrictStr] = Field(
        default=None, description="Seu número do título", alias="seuNumero"
    )
    dt_vencimento: Optional[date] = Field(
        default=None,
        description="Data de vencimento do título (formato aaaa-mm-dd)",
        alias="dtVencimento",
    )
    valor_nominal: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="Valor nominal do título (formato 0.00)",
        alias="valorNominal",
    )
    situacoes: Optional[List[StrictStr]] = Field(
        default=None, description="Situações do título"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FiltroTitulo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FiltroTitulo from a dict"""
        if obj is None:
            return None
