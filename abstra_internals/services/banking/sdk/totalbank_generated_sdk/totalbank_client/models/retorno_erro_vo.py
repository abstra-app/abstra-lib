...
class RetornoErroVO(BaseModel):
    """
    RetornoErroVO
    """  # noqa: E501

    erros: Optional[List[ErroVO]] = Field(default=None, description="Lista de erros.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetornoErroVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetornoErroVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "erros": [ErroVO.from_dict(_item) for _item in obj["erros"]]
