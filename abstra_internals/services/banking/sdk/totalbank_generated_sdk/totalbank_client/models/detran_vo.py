...
class DetranVO(BaseModel):
    ...
    tipo_veiculo: Optional[StrictStr] = Field(
        default=None, description="Tipo do veículo.", alias="tipoVeiculo"
    )
    uf: Optional[StrictStr] = Field(default=None, description="Sigla UF")
    codigo_municipio: Optional[StrictStr] = Field(
        default=None, description="Código do município.", alias="codigoMunicipio"
    )
    ano_crlv: Optional[StrictStr] = Field(
        default=None, description="Ano CRLV.", alias="anoCrlv"
    )
    quantidade_ocorrencia: Optional[StrictInt] = Field(
        default=None,
        description="Quantidade de ocorrências do veículo.",
        alias="quantidadeOcorrencia",
    )
    lista_debitos: Optional[List[DebitoDetranVO]] = Field(
        default=None, description="Lista de débitos.", alias="listaDebitos"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DetranVO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in lista_debitos (list)
        _items = []
        if self.lista_debitos:
            for _item_lista_debitos in self.lista_debitos:
                if _item_lista_debitos:
                    _items.append(_item_lista_debitos.to_dict())
            _dict["listaDebitos"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DetranVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "tipoVeiculo": obj.get("tipoVeiculo"),
                "uf": obj.get("uf"),
                "codigoMunicipio": obj.get("codigoMunicipio"),
                "anoCrlv": obj.get("anoCrlv"),
                "quantidadeOcorrencia": obj.get("quantidadeOcorrencia"),
                "listaDebitos": [
                    DebitoDetranVO.from_dict(_item) for _item in obj["listaDebitos"]
                ]
                if obj.get("listaDebitos") is not None
                else None,
            }
        )
        return _obj
