...
class ListaErroPagamentoPixVO(BaseModel):
    """
    Lista de erros.
    """  # noqa: E501
    ...
    pagamentos_pix: Optional[List[ErroPagamentoPixVO]] = Field(
        default=None,
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListaErroPagamentoPixVO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in pagamentos_pix (list)
        _items = []
        if self.pagamentos_pix:
            for _item_pagamentos_pix in self.pagamentos_pix:
                if _item_pagamentos_pix:
                    _items.append(_item_pagamentos_pix.to_dict())
            _dict["pagamentosPix"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListaErroPagamentoPixVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "pagamentosPix": [
                    ErroPagamentoPixVO.from_dict(_item)
                    for _item in obj["pagamentosPix"]
                ]
                if obj.get("pagamentosPix") is not None
                else None,
            }
        )
        return _obj
