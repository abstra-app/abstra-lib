...
class RetornoPesquisaPaginada(BaseModel):
    """
    ...
    titulos: Optional[List[SimpleTitulo]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetornoPesquisaPaginada from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetornoPesquisaPaginada from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "titulos": [SimpleTitulo.from_dict(_item) for _item in obj["titulos"]]
