...
class ListaErroPagamentoGPSVO(BaseModel):
    """
    Lista de erros.
    """  # noqa: E501
    ...
    pagamentos_gps: Optional[List[ErroPagamentoGPSVO]] = Field(
        default=None,
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListaErroPagamentoGPSVO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in pagamentos_gps (list)
        _items = []
        if self.pagamentos_gps:
            for _item_pagamentos_gps in self.pagamentos_gps:
                if _item_pagamentos_gps:
                    _items.append(_item_pagamentos_gps.to_dict())
            _dict["pagamentosGPS"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListaErroPagamentoGPSVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "pagamentosGPS": [
                    ErroPagamentoGPSVO.from_dict(_item)
                    for _item in obj["pagamentosGPS"]
                ]
                if obj.get("pagamentosGPS") is not None
                else None,
            }
        )
        return _obj
