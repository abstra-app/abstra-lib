...
class RequisicaoPixVencimentoVO(BaseModel):
    """
    ...
    calendario: Optional[PixVencimentoCalendario] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RequisicaoPixVencimentoVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RequisicaoPixVencimentoVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "calendario": PixVencimentoCalendario.from_dict(obj["calendario"])
