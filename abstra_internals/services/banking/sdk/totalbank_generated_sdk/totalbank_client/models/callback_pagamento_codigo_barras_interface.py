...
class CallbackPagamentoCodigoBarrasInterface(BaseModel):
    """
    ...
    valor_juros_mora: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Valor de juros mora", alias="valorJurosMora"
    )
    valor_desconto_abatimento: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Valor do desconto", alias="valorDescontoAbatimento"
    )
    ...
    cod_barras: Optional[StrictStr] = Field(
        default=None, description="Código de barras", alias="codBarras"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallbackPagamentoCodigoBarrasInterface from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallbackPagamentoCodigoBarrasInterface from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "valorJurosMora": obj.get("valorJurosMora"),
