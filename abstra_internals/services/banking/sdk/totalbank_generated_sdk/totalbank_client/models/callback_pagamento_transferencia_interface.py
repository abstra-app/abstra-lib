...
class CallbackPagamentoTransferenciaInterface(BaseModel):
    """
    CallbackPagamentoTransferenciaInterface
    """  # noqa: E501

    dv_agencia_credito: Optional[StrictStr] = Field(
        default=None, description="DV da agência de crédito", alias="dvAgenciaCredito"
    )
    operacao_credito: Optional[StrictStr] = Field(
        default=None,
        description="Operação da conta de crédito",
        alias="operacaoCredito",
    )
    dv_conta_corrente_credito: Optional[StrictStr] = Field(
        default=None,
        description="DV da conta de crédito",
        alias="dvContaCorrenteCredito",
    )
    agencia_credito: Optional[StrictStr] = Field(
        default=None, description="Agência de crédito", alias="agenciaCredito"
    )
    conta_corrente_credito: Optional[StrictStr] = Field(
        default=None, description="Conta de crédito", alias="contaCorrenteCredito"
    )
    endereco: Optional[StrictStr] = Field(
        default=None, description="Endereço do favorecido"
    )
    bairro: Optional[StrictStr] = Field(
        default=None, description="Bairro do endereço do favorecido"
    )
    nome: Optional[StrictStr] = Field(
        default=None, description="Nome/Razão social do favorecido"
    )
    cidade: Optional[StrictStr] = Field(
        default=None, description="Cidade do endereço do favorecido"
    )
    uf: Optional[StrictStr] = Field(
        default=None, description="UF do endereço do favorecido"
    )
    cep: Optional[StrictStr] = Field(
        default=None, description="CEP do endereço do favorecido"
    )
    complemento: Optional[StrictStr] = Field(
        default=None, description="Complemento do endereço do favorecido"
    )
    numero: Optional[StrictStr] = Field(
        default=None, description="Número do endereço do favorecido"
    )
    tipo_pessoa: Optional[StrictStr] = Field(
        default=None, description="Tipo pessoa do favorecido.", alias="tipoPessoa"
    )
    cpf_cnpj: Optional[StrictStr] = Field(
        default=None, description="CPF/CNPJ do favorecido", alias="cpfCnpj"
    )
    banco: Optional[StrictStr] = Field(
        default=None, description="Código do banco de crédito"
    )
    tipo_conta: Optional[StrictStr] = Field(
        default=None, description="Tipo da conta", alias="tipoConta"
    )
    __properties: ClassVar[List[str]] = [
        "dvAgenciaCredito",
        "operacaoCredito",
        "dvContaCorrenteCredito",
        "agenciaCredito",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallbackPagamentoTransferenciaInterface from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallbackPagamentoTransferenciaInterface from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "dvAgenciaCredito": obj.get("dvAgenciaCredito"),
                "operacaoCredito": obj.get("operacaoCredito"),
                "dvContaCorrenteCredito": obj.get("dvContaCorrenteCredito"),
                "agenciaCredito": obj.get("agenciaCredito"),
                "contaCorrenteCredito": obj.get("contaCorrenteCredito"),
                ...
                "tipoPessoa": obj.get("tipoPessoa"),
                "cpfCnpj": obj.get("cpfCnpj"),
                "banco": obj.get("banco"),
                "tipoConta": obj.get("tipoConta"),
            }
        )
        return _obj
