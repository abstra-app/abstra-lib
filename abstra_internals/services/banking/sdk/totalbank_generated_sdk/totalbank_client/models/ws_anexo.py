...
class WSAnexo(BaseModel):
    """
    Lista de comprovantes
    """  # noqa: E501

    nome: Optional[StrictStr] = Field(default=None, description="Nome do arquivo")
    content: Optional[Union[StrictBytes, StrictStr]] = Field(
        default=None, description="Conteúdo byte[] do arquivo"
    )
    mine_type: Optional[StrictStr] = Field(
        default=None, description="Tipo do arquivo", alias="mineType"
    )
    sobrescreve: Optional[StrictBool] = Field(
        default=None, description="Flag para sobrescrever o anexo existente no título"
    )
    url: Optional[StrictStr] = Field(
        default=None,
        description="URL para download do anexo. Retornado apenas na pesquisa de anexos.",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WSAnexo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WSAnexo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "mineType": obj.get("mineType"),
                "sobrescreve": obj.get("sobrescreve"),
                "url": obj.get("url"),
            }
        )
        return _obj
