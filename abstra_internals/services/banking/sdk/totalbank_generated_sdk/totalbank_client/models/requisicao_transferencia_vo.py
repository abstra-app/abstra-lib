...
class RequisicaoTransferenciaVO(BaseModel):
    """
    RequisicaoTransferenciaVO
    """  # noqa: E501

    pagador: Optional[ConvenioVO] = None
    ...
    tipo_servico: Optional[StrictStr] = Field(
        default=None,
        description="Código do tipo de serviço. Códigos disponíveis no enum",
        alias="tipoServico",
    )
    transferencias: Optional[List[TransferenciaVO]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RequisicaoTransferenciaVO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in transferencias (list)
        _items = []
        if self.transferencias:
            for _item_transferencias in self.transferencias:
                if _item_transferencias:
                    _items.append(_item_transferencias.to_dict())
            _dict["transferencias"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RequisicaoTransferenciaVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "pagador": ConvenioVO.from_dict(obj["pagador"])
                ...
                "transferencias": [
                    TransferenciaVO.from_dict(_item) for _item in obj["transferencias"]
                ]
                if obj.get("transferencias") is not None
                else None,
            }
        )
        return _obj
