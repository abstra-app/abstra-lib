...
class ConteudoBoleto(BaseModel):
    """
    ConteudoBoleto
    """  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["nome", "content", "mineType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConteudoBoleto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConteudoBoleto from a dict"""
        if obj is None:
            return None
