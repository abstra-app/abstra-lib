...
class RequisicaoPagamentoCodBarrasVO(BaseModel):
    """
    ...
    pagamentos: Optional[List[PagamentoCodigoBarrasVO]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RequisicaoPagamentoCodBarrasVO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in pagamentos (list)
        _items = []
        if self.pagamentos:
            for _item_pagamentos in self.pagamentos:
                if _item_pagamentos:
                    _items.append(_item_pagamentos.to_dict())
            _dict["pagamentos"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RequisicaoPagamentoCodBarrasVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "pagamentos": [
                    PagamentoCodigoBarrasVO.from_dict(_item)
                    for _item in obj["pagamentos"]
                ]
                if obj.get("pagamentos") is not None
                else None,
            }
        )
        return _obj
