...
class RequisicaoPixImediatoVO(BaseModel):
    """
    ...
    calendario: Optional[PixImediatoCalendario] = None
    devedor: Optional[PixDevedor] = None
    valor: Optional[PixValor] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RequisicaoPixImediatoVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RequisicaoPixImediatoVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "calendario": PixImediatoCalendario.from_dict(obj["calendario"])
                if obj.get("calendario") is not None
                else None,
                "devedor": PixDevedor.from_dict(obj["devedor"])
                if obj.get("devedor") is not None
                else None,
                "valor": PixValor.from_dict(obj["valor"])
