...
class RequisicaoPixDevolucaoVO(BaseModel):
    """
    Dados para pedido de devolução.
    """  # noqa: E501

    txid: Optional[StrictStr] = Field(default=None, description="Id do pix")
    ...
    __properties: ClassVar[List[str]] = ["txid", "autenticacao", "valor"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RequisicaoPixDevolucaoVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RequisicaoPixDevolucaoVO from a dict"""
        if obj is None:
            return None
