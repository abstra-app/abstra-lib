...
class RequisicaoExclusaoPagamentoVO(BaseModel):
    """
    RequisicaoExclusaoPagamentoVO
    """  # noqa: E501

    pagador: Optional[ConvenioSimplesVO] = None
    pagamentos: Optional[List[FiltroPagamentoMovimentacaoVO]] = Field(
        default=None,
        description="Lista de pagamentos a excluir, limite de 300 pagamentos",
    )
    __properties: ClassVar[List[str]] = ["pagador", "pagamentos"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RequisicaoExclusaoPagamentoVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RequisicaoExclusaoPagamentoVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "pagador": ConvenioSimplesVO.from_dict(obj["pagador"])
                if obj.get("pagador") is not None
                else None,
                "pagamentos": [
                    FiltroPagamentoMovimentacaoVO.from_dict(_item)
