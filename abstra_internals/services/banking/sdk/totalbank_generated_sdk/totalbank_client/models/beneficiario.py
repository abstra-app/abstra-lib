...
class Beneficiario(BaseModel):
    ...
    codigo_banco: Optional[StrictStr] = Field(
        default=None, description="Código do banco do beneficiário", alias="codigoBanco"
    )
    codigo_beneficiario: Optional[StrictStr] = Field(
        default=None, description="Código do beneficiário", alias="codigoBeneficiario"
    )
    cnpj_beneficiario: Optional[StrictStr] = Field(
        default=None, description="CNPJ do beneficiário", alias="cnpjBeneficiario"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Beneficiario from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Beneficiario from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "cnpjBeneficiario": obj.get("cnpjBeneficiario"),
            }
        )
        return _obj
