...
class RetornoPagamentoDetranVO(BaseModel):
    """
    RetornoPagamentoDetranVO
    """  # noqa: E501

    convenio: Optional[StrictStr] = Field(
        default=None, description="Descrição do convênio"
    )
    banco: Optional[StrictStr] = Field(default=None, description="Descrição do banco")
    conta: Optional[StrictStr] = Field(default=None, description="Descrição da conta")
    data_pagamento: Optional[StrictStr] = Field(
        default=None,
        description="Data do pagamento (formato dd/mm/aaaa)",
        alias="dataPagamento",
    )
    quantidade_pagamento: Optional[StrictInt] = Field(
        default=None, description="Quantidade de pagamento", alias="quantidadePagamento"
    )
    total_pagamento: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="Valor total do pagamento em reais (formato 0.00)",
        alias="totalPagamento",
    )
    status: Optional[StrictStr] = Field(default=None, description="Status do pagamento")
    observacao: Optional[StrictStr] = Field(default=None, description="Observação")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetornoPagamentoDetranVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetornoPagamentoDetranVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "convenio": obj.get("convenio"),
                "banco": obj.get("banco"),
                "conta": obj.get("conta"),
                "dataPagamento": obj.get("dataPagamento"),
                "quantidadePagamento": obj.get("quantidadePagamento"),
                "totalPagamento": obj.get("totalPagamento"),
