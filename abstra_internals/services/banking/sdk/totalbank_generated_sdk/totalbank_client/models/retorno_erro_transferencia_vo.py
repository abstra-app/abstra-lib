...
class RetornoErroTransferenciaVO(BaseModel):
    """
    RetornoErroTransferenciaVO
    """  # noqa: E501

    erros: Optional[List[ListaErroTransferenciaVO]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetornoErroTransferenciaVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetornoErroTransferenciaVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "erros": [
                    ListaErroTransferenciaVO.from_dict(_item) for _item in obj["erros"]
                ]
