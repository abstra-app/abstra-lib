...
class ChaveAleatoria(BaseModel):
    """
    Chave aleatória do PIX
    """  # noqa: E501

    chave_aleatoria: Optional[StrictStr] = Field(
        default=None, description="Chave aleatória do PIX.", alias="chaveAleatoria"
    )
    __properties: ClassVar[List[str]] = ["chaveAleatoria"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChaveAleatoria from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChaveAleatoria from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"chaveAleatoria": obj.get("chaveAleatoria")})
        return _obj
