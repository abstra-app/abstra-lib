...
class EnderecoVO(BaseModel):
    """
    Dados do endereço do favorecido
    """  # noqa: E501

    cep: Optional[StrictStr] = Field(
        default=None, description="CEP do endereço, somente números"
    )
    endereco: Optional[StrictStr] = Field(default=None, description="Endereço")
    numero: Optional[StrictStr] = Field(default=None, description="Número do endereço")
    complemento: Optional[StrictStr] = Field(
        default=None, description="Complemento do endereço"
    )
    bairro: Optional[StrictStr] = Field(default=None, description="Bairro do endereço")
    cidade: Optional[StrictStr] = Field(default=None, description="Cidade do endereço")
    estado: Optional[StrictStr] = Field(
        default=None, description="Sigla UF do endereço"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EnderecoVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EnderecoVO from a dict"""
        if obj is None:
            return None
