...
class DebitoDetranVO(BaseModel):
    """
    Débitos do veículo
    """  # noqa: E501
    ...
    pode_ser_pago_sozinho: Optional[StrictBool] = Field(
        default=None,
        description="Flag que indica que pode ser pago sozinho ou não (tem que pagar todos os tributos retornados juntos",
    ...
    nome_tributo: Optional[StrictStr] = Field(
        default=None, description="Descrição do tributo", alias="nomeTributo"
    )
    descricao_tributo: Optional[StrictStr] = Field(
        default=None,
        description="Complemento da descrição do tributo",
        alias="descricaoTributo",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DebitoDetranVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DebitoDetranVO from a dict"""
        if obj is None:
            return None
