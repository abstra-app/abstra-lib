...
class Desconto(BaseModel):
    ...
    dt_desconto: Optional[date] = Field(
        default=None,
        description="Data de desconto (formato aaaa-mm-dd)",
        alias="dtDesconto",
    )
    valor: Optional[
        Union[
    ...
    __properties: ClassVar[List[str]] = ["tipo", "dtDesconto", "valor"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Desconto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Desconto from a dict"""
        if obj is None:
            return None
