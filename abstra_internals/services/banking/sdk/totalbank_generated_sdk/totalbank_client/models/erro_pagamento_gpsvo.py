...
class ErroPagamentoGPSVO(BaseModel):
    """
    Pagamento de GPS
    """  # noqa: E501
    ...
    nome_contribuinte: Optional[StrictStr] = Field(
        default=None, description="Nome do contribuinte", alias="nomeContribuinte"
    )
    numero_identificacao_contribuinte: Optional[StrictStr] = Field(
        default=None,
        description="Número de identificação do contribuinte",
        alias="numeroIdentificacaoContribuinte",
    )
    codigo_tipo_contribuinte: Optional[StrictStr] = Field(
        default=None,
        description="Código do tipo de contribuinte na Guia da Previdência Social",
        alias="codigoTipoContribuinte",
    )
    codigo_receita: Optional[StrictInt] = Field(
        default=None,
        description="Código da Receita do Tributo GPS",
        alias="codigoReceita",
    )
    mes_ano_competencia: Optional[StrictStr] = Field(
        default=None,
        description='Mês e ano de competência. Formato: "mmaaaa"',
        alias="mesAnoCompetencia",
    )
    valor_inss: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="Valor devido ao INSS pelo contribuinte, em reais (formato 0.00)",
        alias="valorINSS",
    )
    valor_outras_entidades: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="Valor outras entidades, em reais (formato 0.00)",
        alias="valorOutrasEntidades",
    )
    valor_atualizacao_monetaria: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="Valor da atualização monetária/Multa e juros, em reais (formato 0.00)",
        alias="valorAtualizacaoMonetaria",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ErroPagamentoGPSVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ErroPagamentoGPSVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "nomeContribuinte": obj.get("nomeContribuinte"),
                "numeroIdentificacaoContribuinte": obj.get(
                    "numeroIdentificacaoContribuinte"
                ),
                "codigoTipoContribuinte": obj.get("codigoTipoContribuinte"),
                "codigoReceita": obj.get("codigoReceita"),
                "mesAnoCompetencia": obj.get("mesAnoCompetencia"),
                "valorINSS": obj.get("valorINSS"),
                "valorOutrasEntidades": obj.get("valorOutrasEntidades"),
                "valorAtualizacaoMonetaria": obj.get("valorAtualizacaoMonetaria"),
            }
        )
        return _obj
