...
class LancamentoVO(BaseModel):
    """
    Lançamentos
    """  # noqa: E501

    conta: Optional[ContaVO] = None
    data: Optional[date] = Field(default=None, description="Data")
    categoria_lancamento: Optional[StrictStr] = Field(
        default=None, description="Categoria do lançamento", alias="categoriaLancamento"
    )
    lancamento: Optional[StrictStr] = Field(default=None, description="Lançamento")
    historico: Optional[StrictStr] = Field(default=None, description="Histórico")
    documento: Optional[StrictStr] = Field(default=None, description="Documento")
    banco_origem: Optional[StrictStr] = Field(
        default=None, description="Banco origem", alias="bancoOrigem"
    )
    agencia_origem: Optional[StrictStr] = Field(
        default=None, description="Agência origem", alias="agenciaOrigem"
    )
    conta_origem: Optional[StrictStr] = Field(
        default=None, description="Conta origem", alias="contaOrigem"
    )
    dv_conta_origem: Optional[StrictStr] = Field(
        default=None, description="DV conta origem", alias="dvContaOrigem"
    )
    nome_origem: Optional[StrictStr] = Field(
        default=None, description="Nome origem", alias="nomeOrigem"
    )
    inscricao_origem: Optional[StrictStr] = Field(
        default=None, description="Inscrição origem", alias="inscricaoOrigem"
    )
    line_in_lote: Optional[StrictInt] = Field(
        default=None, description="Linha de Lote", alias="lineInLote"
    )
    valor: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Valor"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LancamentoVO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of conta
        if self.conta:
            _dict["conta"] = self.conta.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LancamentoVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "conta": ContaVO.from_dict(obj["conta"])
                if obj.get("conta") is not None
                else None,
                "data": obj.get("data"),
                "categoriaLancamento": obj.get("categoriaLancamento"),
                "lancamento": obj.get("lancamento"),
                "historico": obj.get("historico"),
                "documento": obj.get("documento"),
                "bancoOrigem": obj.get("bancoOrigem"),
                "agenciaOrigem": obj.get("agenciaOrigem"),
                "contaOrigem": obj.get("contaOrigem"),
                "dvContaOrigem": obj.get("dvContaOrigem"),
                "nomeOrigem": obj.get("nomeOrigem"),
                "inscricaoOrigem": obj.get("inscricaoOrigem"),
                "lineInLote": obj.get("lineInLote"),
                "valor": obj.get("valor"),
            }
        )
        return _obj
