...
class ErroContaCorrenteVO(BaseModel):
    """
    ErroContaCorrenteVO
    """  # noqa: E501

    codigo: Optional[StrictInt] = Field(
    ...
    erro: Optional[StrictStr] = Field(default=None, description="Tipo de erro")
    detalhe: Optional[StrictStr] = Field(default=None, description="Detalhe")
    __properties: ClassVar[List[str]] = ["codigo", "tipoErro", "erro", "detalhe"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ErroContaCorrenteVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ErroContaCorrenteVO from a dict"""
        if obj is None:
            return None
