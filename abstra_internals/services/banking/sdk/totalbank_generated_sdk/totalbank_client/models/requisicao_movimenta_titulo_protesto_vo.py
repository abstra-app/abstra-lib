...
class RequisicaoMovimentaTituloProtestoVO(BaseModel):
    """
    ...
    dias_protesto: Optional[StrictInt] = Field(
        default=None, description="Dias de protesto do título", alias="diasProtesto"
    )
    __properties: ClassVar[List[str]] = ["beneficiario", "titulos", "diasProtesto"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RequisicaoMovimentaTituloProtestoVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RequisicaoMovimentaTituloProtestoVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "diasProtesto": obj.get("diasProtesto"),
            }
        )
        return _obj
