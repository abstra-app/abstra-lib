...
class ErroPagamentoDetranVO(BaseModel):
    """
    Retornado quando tipo do erro=7. Erro detalhado no campo msgValidacao de cada pagamento.
    """  # noqa: E501
    ...
    codigo_tributo: Optional[StrictInt] = Field(
        default=None, description="Código do tributo", alias="codigoTributo"
    )
    nome_tributo: Optional[StrictStr] = Field(
        default=None, description="Nome do tributo", alias="nomeTributo"
    )
    descricao_tributo: Optional[StrictStr] = Field(
        default=None, description="Descrição do tributo", alias="descricaoTributo"
    )
    ano_tributo: Optional[StrictStr] = Field(
        default=None, description="Ano de exercício do tributo", alias="anoTributo"
    )
    valor_tributo: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Valor do tributo", alias="valorTributo"
    )
    pode_ser_pago_sozinho: Optional[StrictBool] = Field(
        default=None,
        description="Flag que indica que pode ser pago sozinho ou não (retornado na consulta via renavam)",
        alias="podeSerPagoSozinho",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ErroPagamentoDetranVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ErroPagamentoDetranVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "codigoTributo": obj.get("codigoTributo"),
                "nomeTributo": obj.get("nomeTributo"),
                "descricaoTributo": obj.get("descricaoTributo"),
                "anoTributo": obj.get("anoTributo"),
                "valorTributo": obj.get("valorTributo"),
                "podeSerPagoSozinho": obj.get("podeSerPagoSozinho"),
            }
        )
        return _obj
