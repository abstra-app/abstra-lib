...
class BeneficiarioTitulo(BaseModel):
    """
    Beneficiário do titulo
    """  # noqa: E501

    inscricao: Optional[StrictStr] = Field(default=None, description="CPF/CNPJ")
    nome: Optional[StrictStr] = Field(default=None, description="Nome")
    endereco: Optional[StrictStr] = Field(
        default=None, description="Endereço completo do beneficiário"
    )
    __properties: ClassVar[List[str]] = ["inscricao", "nome", "endereco"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BeneficiarioTitulo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BeneficiarioTitulo from a dict"""
        if obj is None:
            return None
