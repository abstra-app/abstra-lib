...
class RetornoPixVencimentoCalendario(BaseModel):
    """
    RetornoPixVencimentoCalendario
    """  # noqa: E501

    data_de_vencimento: Optional[date] = Field(
        default=None,
        description="Data de vencimento da cobrança (formato yyyy-MM-dd)",
        alias="dataDeVencimento",
    )
    validade_apos_vencimento: Optional[StrictInt] = Field(
        default=None,
    ...
    criacao: Optional[datetime] = Field(
        default=None, description="Data de criação (formato yyyy-MM-dd HH:mm:ss.SSS)"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetornoPixVencimentoCalendario from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetornoPixVencimentoCalendario from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "dataDeVencimento": obj.get("dataDeVencimento"),
                "validadeAposVencimento": obj.get("validadeAposVencimento"),
                "criacao": obj.get("criacao"),
            }
        )
        return _obj
