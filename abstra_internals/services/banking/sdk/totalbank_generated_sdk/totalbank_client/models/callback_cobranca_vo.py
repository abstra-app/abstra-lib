...
class CallbackCobrancaVO(BaseModel):
    """
    CallbackCobrancaVO
    """  # noqa: E501
    ...
    beneficiario: Optional[CallbackConvenioVO] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallbackCobrancaVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallbackCobrancaVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "beneficiario": CallbackConvenioVO.from_dict(obj["beneficiario"])
