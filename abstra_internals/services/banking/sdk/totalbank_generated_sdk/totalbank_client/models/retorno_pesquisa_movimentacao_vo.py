...
class RetornoPesquisaMovimentacaoVO(BaseModel):
    """
    RetornoPesquisaMovimentacaoVO
    """  # noqa: E501

    paginacao: Optional[RetornoPaginacao] = None
    movimentacoes: Optional[List[PagamentoMovimentacaoVO]] = None
    __properties: ClassVar[List[str]] = ["paginacao", "movimentacoes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetornoPesquisaMovimentacaoVO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in movimentacoes (list)
        _items = []
        if self.movimentacoes:
            for _item_movimentacoes in self.movimentacoes:
                if _item_movimentacoes:
                    _items.append(_item_movimentacoes.to_dict())
            _dict["movimentacoes"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetornoPesquisaMovimentacaoVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "movimentacoes": [
                    PagamentoMovimentacaoVO.from_dict(_item)
                    for _item in obj["movimentacoes"]
                ]
                if obj.get("movimentacoes") is not None
                else None,
            }
        )
        return _obj
