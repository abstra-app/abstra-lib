...
class RetornoTitulo(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="Status do título")
    ...
    codigo_barras: Optional[StrictStr] = Field(
        default=None,
        description="Codigo de barras do boleto registrado",
        alias="codigoBarras",
    )
    linha_digitavel: Optional[StrictStr] = Field(
        default=None, description="Linha digitavel do boleto", alias="linhaDigitavel"
    )
    mensagem_erro: Optional[StrictStr] = Field(
        default=None, description="Mensagem de erro", alias="mensagemErro"
    )
    url_boleto: Optional[StrictStr] = Field(
        default=None,
        description="URL do boleto, retornada apenas quando o nosso número estiver preenchido",
        alias="urlBoleto",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetornoTitulo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetornoTitulo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "mensagemErro": obj.get("mensagemErro"),
