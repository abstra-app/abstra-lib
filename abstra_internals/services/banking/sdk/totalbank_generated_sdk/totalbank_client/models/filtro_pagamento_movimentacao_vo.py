...
class FiltroPagamentoMovimentacaoVO(BaseModel):
    """
    Lista de pagamentos a excluir, limite de 300 pagamentos
    """  # noqa: E501

    cpf_cnpj_beneficiario: Optional[StrictStr] = Field(
        default=None,
        description="CPF ou CNPJ do beneficiário (favorecido)",
        alias="cpfCnpjBeneficiario",
    )
    data_agendamento: Optional[StrictStr] = Field(
        default=None,
        description="Data de agendamento (formato aaaa-mm-dd)",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FiltroPagamentoMovimentacaoVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FiltroPagamentoMovimentacaoVO from a dict"""
        if obj is None:
            return None
