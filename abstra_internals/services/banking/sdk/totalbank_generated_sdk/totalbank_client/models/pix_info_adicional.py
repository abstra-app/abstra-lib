...
class PixInfoAdicional(BaseModel):
    """
    Informações adicionais
    """  # noqa: E501

    nome: Optional[StrictStr] = Field(default=None, description="Nome do campo")
    valor: Optional[StrictStr] = Field(default=None, description="Dados do campo")
    __properties: ClassVar[List[str]] = ["nome", "valor"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PixInfoAdicional from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PixInfoAdicional from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"nome": obj.get("nome"), "valor": obj.get("valor")})
        return _obj
