...
class Multa(BaseModel):
    ...
    dt_multa: Optional[date] = Field(
        default=None, description="Data de multa (formato aaaa-mm-dd)", alias="dtMulta"
    )
    valor: Optional[
        Union[
    ...
    __properties: ClassVar[List[str]] = ["tipo", "dtMulta", "valor"]
