...
class ConvenioVO(BaseModel):
    ...
    conta_debito: Optional[ContaDebitoVO] = Field(default=None, alias="contaDebito")
    parametro_pagamento: Optional[ParametroPagamentoVO] = Field(
        default=None, alias="parametroPagamento"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConvenioVO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of conta_debito
        if self.conta_debito:
            _dict["contaDebito"] = self.conta_debito.to_dict()
        # override the default output from pydantic by calling `to_dict()` of parametro_pagamento
        if self.parametro_pagamento:
            _dict["parametroPagamento"] = self.parametro_pagamento.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConvenioVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "contaDebito": ContaDebitoVO.from_dict(obj["contaDebito"])
                if obj.get("contaDebito") is not None
                else None,
                "parametroPagamento": ParametroPagamentoVO.from_dict(
                    obj["parametroPagamento"]
                )
                if obj.get("parametroPagamento") is not None
                else None,
            }
        )
        return _obj
