...
class ListaErroCodigoBarrasVO(BaseModel):
    """
    Lista de erros.
    """  # noqa: E501
    ...
    pagamentos_cod_barras: Optional[List[ErroPagamentoCodigoBarrasVO]] = Field(
        default=None,
        description="Retornado quando tipo do erro=7. Erro detalhado no campo erro de cada pagamento.",
        alias="pagamentosCodBarras",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListaErroCodigoBarrasVO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in pagamentos_cod_barras (list)
        _items = []
        if self.pagamentos_cod_barras:
            for _item_pagamentos_cod_barras in self.pagamentos_cod_barras:
                if _item_pagamentos_cod_barras:
                    _items.append(_item_pagamentos_cod_barras.to_dict())
            _dict["pagamentosCodBarras"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListaErroCodigoBarrasVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "pagamentosCodBarras": [
                    ErroPagamentoCodigoBarrasVO.from_dict(_item)
                    for _item in obj["pagamentosCodBarras"]
                ]
                if obj.get("pagamentosCodBarras") is not None
                else None,
            }
        )
        return _obj
