...
class ErroTransferenciaVO(BaseModel):
    """
    Retornado quando tipo do erro=7. Erro detalhado no campo msgValidacao de cada transferência.
    """  # noqa: E501
    ...
    favorecido: Optional[FavorecidoTransferenciaVO] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ErroTransferenciaVO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of favorecido
        if self.favorecido:
            _dict["favorecido"] = self.favorecido.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ErroTransferenciaVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "favorecido": FavorecidoTransferenciaVO.from_dict(obj["favorecido"])
                if obj.get("favorecido") is not None
                else None,
            }
        )
        return _obj
