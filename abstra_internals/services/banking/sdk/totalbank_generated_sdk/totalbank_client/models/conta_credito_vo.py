...
class ContaCreditoVO(BaseModel):
    """
    Dados da conta de destino do favorecido
    """  # noqa: E501
    ...
    banco: Optional[StrictStr] = Field(
        default=None, description="Código do banco para crédito"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContaCreditoVO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContaCreditoVO from a dict"""
        if obj is None:
            return None
