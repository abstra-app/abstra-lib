...
import abstra_internals.services.banking.sdk.totalbank_generated_sdk.totalbank_client.models as totalbank_client_models
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(totalbank_client_models, klass)
