...
class PagamentoCadastroApi:
    ...
    @validate_call
    def favorecido_alterar(
        self,
        favorecido_vo: Optional[FavorecidoVO] = None,
        ...
        """Alterar um favorecido

        Alterar um favorecido.

        :param favorecido_vo:
        :type favorecido_vo: FavorecidoVO
        ...
        _param = self._favorecido_alterar_serialize(
            favorecido_vo=favorecido_vo,
    ...
    @validate_call
    def favorecido_alterar_with_http_info(
        self,
        favorecido_vo: Optional[FavorecidoVO] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def favorecido_alterar_without_preload_content(
        self,
        favorecido_vo: Optional[FavorecidoVO] = None,
        _request_timeout: Union[
            None,
    ...
    def _favorecido_alterar_serialize(
        self,
        favorecido_vo,
        _request_auth,
        _content_type,
        ...
        if favorecido_vo is not None:
            _body_params = favorecido_vo
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/rest/pagamento/favorecido/alterar",
    ...
    def favorecido_cadastrar(
        ...
        _param = self._favorecido_cadastrar_serialize(
            favorecido_vo=favorecido_vo,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def favorecido_cadastrar_with_http_info(
        self,
        favorecido_vo: Optional[FavorecidoVO] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def favorecido_cadastrar_without_preload_content(
        self,
        favorecido_vo: Optional[FavorecidoVO] = None,
        _request_timeout: Union[
            None,
    ...
    def _favorecido_cadastrar_serialize(
        self,
        favorecido_vo,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/rest/pagamento/favorecido/cadastrar",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def favorecido_excluir(
        self,
        funcionario_favorecido_excluir_vo: Optional[
            FuncionarioFavorecidoExcluirVO
        ] = None,
        _request_timeout: Union[
            None,
        ...
        :param funcionario_favorecido_excluir_vo:
        :type funcionario_favorecido_excluir_vo: FuncionarioFavorecidoExcluirVO
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._favorecido_excluir_serialize(
            funcionario_favorecido_excluir_vo=funcionario_favorecido_excluir_vo,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def favorecido_excluir_with_http_info(
        self,
        funcionario_favorecido_excluir_vo: Optional[
            FuncionarioFavorecidoExcluirVO
        ] = None,
    ...
    @validate_call
    def favorecido_excluir_without_preload_content(
        self,
        funcionario_favorecido_excluir_vo: Optional[
            FuncionarioFavorecidoExcluirVO
        ] = None,
    ...
    def _favorecido_excluir_serialize(
        self,
        funcionario_favorecido_excluir_vo,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if funcionario_favorecido_excluir_vo is not None:
            _body_params = funcionario_favorecido_excluir_vo
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/rest/pagamento/favorecido/excluir",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def favorecido_excluir_dados_bancarios(
        self,
        dados_bancarios_excluir_vo: Optional[DadosBancariosExcluirVO] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """Excluir dados bancários de um favorecido

        Excluir dados bancários de um favorecido.

        :param dados_bancarios_excluir_vo:
        :type dados_bancarios_excluir_vo: DadosBancariosExcluirVO
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._favorecido_excluir_dados_bancarios_serialize(
            dados_bancarios_excluir_vo=dados_bancarios_excluir_vo,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def favorecido_excluir_dados_bancarios_with_http_info(
        self,
        dados_bancarios_excluir_vo: Optional[DadosBancariosExcluirVO] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def favorecido_excluir_dados_bancarios_without_preload_content(
        self,
        dados_bancarios_excluir_vo: Optional[DadosBancariosExcluirVO] = None,
        _request_timeout: Union[
            None,
    ...
    def _favorecido_excluir_dados_bancarios_serialize(
        self,
        dados_bancarios_excluir_vo,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if dados_bancarios_excluir_vo is not None:
            _body_params = dados_bancarios_excluir_vo
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/rest/pagamento/favorecido/excluirDadosBancarios",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
