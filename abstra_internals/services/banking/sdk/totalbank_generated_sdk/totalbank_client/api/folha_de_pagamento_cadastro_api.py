...
class FolhaDePagamentoCadastroApi:
    ...
    @validate_call
    def funcionario_alterar(
        self,
        funcionario_vo: Optional[FuncionarioVO] = None,
        ...
        :param funcionario_vo:
        :type funcionario_vo: FuncionarioVO
        ...
        _param = self._funcionario_alterar_serialize(
            funcionario_vo=funcionario_vo,
    ...
    @validate_call
    def funcionario_alterar_with_http_info(
        self,
        funcionario_vo: Optional[FuncionarioVO] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def funcionario_alterar_without_preload_content(
        self,
        funcionario_vo: Optional[FuncionarioVO] = None,
        _request_timeout: Union[
            None,
    ...
    def _funcionario_alterar_serialize(
        self,
        funcionario_vo,
        _request_auth,
        _content_type,
        ...
        if funcionario_vo is not None:
            _body_params = funcionario_vo
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/rest/pagamento/funcionario/alterar",
    ...
    def funcionario_cadastrar(
        ...
        _param = self._funcionario_cadastrar_serialize(
            funcionario_vo=funcionario_vo,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def funcionario_cadastrar_with_http_info(
        self,
        funcionario_vo: Optional[FuncionarioVO] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def funcionario_cadastrar_without_preload_content(
        self,
        funcionario_vo: Optional[FuncionarioVO] = None,
        _request_timeout: Union[
            None,
    ...
    def _funcionario_cadastrar_serialize(
        self,
        funcionario_vo,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/rest/pagamento/funcionario/cadastrar",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def funcionario_excluir(
        ...
        _param = self._funcionario_excluir_serialize(
    ...
    @validate_call
    def funcionario_excluir_with_http_info(
        self,
        funcionario_favorecido_excluir_vo: Optional[
            FuncionarioFavorecidoExcluirVO
        ] = None,
    ...
    @validate_call
    def funcionario_excluir_without_preload_content(
        self,
        funcionario_favorecido_excluir_vo: Optional[
            FuncionarioFavorecidoExcluirVO
        ] = None,
    ...
    def _funcionario_excluir_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/rest/pagamento/funcionario/excluir",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def funcionario_excluir_dados_bancarios(
        self,
        ...
        """Excluir dados bancários de um funcionário
        ...
        _param = self._funcionario_excluir_dados_bancarios_serialize(
    ...
    @validate_call
    def funcionario_excluir_dados_bancarios_with_http_info(
        self,
        dados_bancarios_excluir_vo: Optional[DadosBancariosExcluirVO] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def funcionario_excluir_dados_bancarios_without_preload_content(
        self,
        dados_bancarios_excluir_vo: Optional[DadosBancariosExcluirVO] = None,
        _request_timeout: Union[
            None,
    ...
    def _funcionario_excluir_dados_bancarios_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/rest/pagamento/funcionario/excluirDadosBancarios",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
